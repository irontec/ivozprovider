...
En la siguiente sección veremos como también se puede apuntar un :ref:`DDI externo <external_ddis>` a una sala de conferencias, para meter en la sala a gente externa a la empresa.

.. hint:: Existen otras formas de meter un participante externo a una sala de audioconferencias sin dedicar un DDI externo: que alguien de dentro transfiera la llamada a la extensión de la sala, acceder por medio de un IVR, etc.
