...
Background:
  ...
  Given I click on "MatchLists" first elements "matchListPatterns" button
  Then I am on "MatchListsList_matchListPatterns" subscreen list

  Scenario: I can save  matchlist pattern in
    Given I can see at least one row
    And I click on "matchListPatterns" first elements edit button
  ...
  Scenario: I can click on delete matchlist pattern in button
    Given I can see at least one row
    And I click on "matchListPatterns" first elements delete button
    Then I can see confirmation dialog
    Given I click on close dialog button
    Then I am on "MatchListsList_matchListPatterns" subscreen list