...
class Rest_MusicOnHoldController extends Iron_Controller_Rest_BaseController
{
    ...
    /**
     * @ApiDescription(section="MusicOnHold", description="GET information about all MusicOnHold")
     * @ApiMethod(type="get")
     * @ApiRoute(name="/rest/music-on-hold/")
    ...
    public function indexAction()
    {
        ...
        $etag = $this->_cache->getEtagVersions('MusicOnHold');
        ...
        $mapper = new Mappers\MusicOnHold();
    ...
    /**
     * @ApiDescription(section="MusicOnHold", description="Get information about MusicOnHold")
     * @ApiMethod(type="get")
     * @ApiRoute(name="/rest/music-on-hold/{id}")
    ...
    /**
     * @ApiDescription(section="MusicOnHold", description="Create's a new MusicOnHold")
     * @ApiMethod(type="post")
     * @ApiRoute(name="/rest/music-on-hold/")
     ...
     * @ApiReturnHeaders(sample="Location: /rest/musiconhold/{id}")
     * @ApiReturn(type="object", sample="{}")
     */
    ...
    /**
     * @ApiDescription(section="MusicOnHold", description="Table MusicOnHold")
     * @ApiMethod(type="put")
     * @ApiRoute(name="/rest/music-on-hold/")
