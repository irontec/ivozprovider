...
class Rest_IVRCommonController extends Iron_Controller_Rest_BaseController
{
    ...
    /**
     * @ApiDescription(section="IVRCommon", description="GET information about all IVRCommon")
     * @ApiMethod(type="get")
     * @ApiRoute(name="/rest/i-v-r-common/")
    ...
    public function indexAction()
    {
        ...
        $etag = $this->_cache->getEtagVersions('IVRCommon');
    ...
    /**
     * @ApiDescription(section="IVRCommon", description="Get information about IVRCommon")
     * @ApiMethod(type="get")
     * @ApiRoute(name="/rest/i-v-r-common/{id}")
    ...
    /**
     * @ApiDescription(section="IVRCommon", description="Create's a new IVRCommon")
     * @ApiMethod(type="post")
     * @ApiRoute(name="/rest/i-v-r-common/")
     ...
     * @ApiReturnHeaders(sample="Location: /rest/ivrcommon/{id}")
     * @ApiReturn(type="object", sample="{}")
     */
    ...
    /**
     * @ApiDescription(section="IVRCommon", description="Table IVRCommon")
     * @ApiMethod(type="put")
     * @ApiRoute(name="/rest/i-v-r-common/")
