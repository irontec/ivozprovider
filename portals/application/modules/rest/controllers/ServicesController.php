...
class Rest_ServicesController extends Iron_Controller_Rest_BaseController
{
    ...
    /**
     * @ApiDescription(section="Services", description="GET information about all Services")
     * @ApiMethod(type="get")
     * @ApiRoute(name="/rest/services/")
    ...
    public function indexAction()
    {
        ...
        $etag = $this->_cache->getEtagVersions('Services');
    ...
    /**
     * @ApiDescription(section="Services", description="Get information about Services")
     * @ApiMethod(type="get")
     * @ApiRoute(name="/rest/services/{id}")
    ...
    /**
     * @ApiDescription(section="Services", description="Create's a new Services")
     * @ApiMethod(type="post")
     * @ApiRoute(name="/rest/services/")
    ...
    /**
     * @ApiDescription(section="Services", description="Table Services")
     * @ApiMethod(type="put")
     * @ApiRoute(name="/rest/services/")
