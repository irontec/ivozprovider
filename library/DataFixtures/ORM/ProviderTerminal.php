...
class ProviderTerminal extends Fixture implements DependentFixtureInterface
{
    ...
    public function load(ObjectManager $manager)
    {
        ...
        $item1->setTerminalModel($this->getReference('_reference_IvozProviderDomainModelTerminalModelTerminalModel1'));
        $this->addReference('_reference_IvozProviderDomainModelTerminalTerminal1', $item1);
        ...
        $item2->setDomain($this->getReference('_reference_IvozProviderDomainModelDomainDomain3'));
        $item2->setTerminalModel($this->getReference('_reference_IvozProviderDomainModelTerminalModelTerminalModel1'));
        $this->addReference('_reference_IvozProviderDomainModelTerminalTerminal2', $item2);
        ...
        $item3->setDomain($this->getReference('_reference_IvozProviderDomainModelDomainDomain3'));
        $item3->setTerminalModel($this->getReference('_reference_IvozProviderDomainModelTerminalModelTerminalModel1'));
        $this->addReference('_reference_IvozProviderDomainModelTerminalTerminal3', $item3);
