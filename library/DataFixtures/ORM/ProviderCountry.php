...
class ProviderCountry extends Fixture
{
    ...
    public function load(ObjectManager $manager)
    {
        ...
        (function () {
            ...
            $this->setName(new Name('Andorra', 'Andorra', 'Andorra'));
            $this->setZone(new Zone('Europe', 'Europa', 'Europa'));
        })->call($item1);
        ...
        (function () {
            ...
            $this->setName(new Name('United Arab Emirates', 'Emiratos Árabes Unidos', 'Emiratos Árabes Unidos'));
            $this->setZone(new Zone('Asia', 'Asia', 'Asia'));
        })->call($item2);
        ...
        (function () {
            ...
            $this->setName(new Name('Afghanistan', 'Afganistán', 'Afganistán'));
            $this->setZone(new Zone('Asia', 'Asia', 'Asia'));
        })->call($item3);
        ...
        (function () {
            ...
            $this->setName(new Name('Antigua and Barbuda', 'Antigua y Barbuda', 'Antigua y Barbuda'));
            $this->setZone(new Zone('North america', 'North america', 'North america'));
        })->call($item4);
        ...
        (function () {
            ...
            $this->setName(new Name('Anguilla', 'Anguila', 'Anguila'));
            $this->setZone(new Zone('North america', 'North america', 'North america'));
        })->call($item5);
        ...
        (function () {
            ...
            $this->setName(new Name('Albania', 'Albania', 'Albania'));
            $this->setZone(new Zone('Europe', 'Europa', 'Europa'));
        })->call($item6);
        ...
        (function () {
            ...
            $this->setName(new Name('Armenia', 'Armenia', 'Armenia'));
            $this->setZone(new Zone('Asia', 'Asia', 'Asia'));
        })->call($item7);
        ...
        (function () {
            ...
            $this->setName(new Name('Angola', 'Angola', 'Angola'));
            $this->setZone(new Zone('Africa', 'Africa', 'Africa'));
        })->call($item8);
        ...
        (function () {
            ...
            $this->setName(new Name('Antarctica', 'Antártida', 'Antártida'));
            $this->setZone(new Zone('Antarctica', 'Antarctica', 'Antarctica'));
        })->call($item9);
        ...
        (function () {
            ...
            $this->setName(new Name('Argentina', 'Argentina', 'Argentina'));
            $this->setZone(new Zone('South america', 'South america', 'South america'));
        })->call($item10);
        ...
        (function () {
            ...
            $this->setName(new Name('American Samoa', 'Samoa Americana', 'Samoa Americana'));
            $this->setZone(new Zone('Oceania', 'Oceania', 'Oceania'));
        })->call($item11);
        ...
        (function () {
            ...
            $this->setName(new Name('Austria', 'Austria', 'Austria'));
            $this->setZone(new Zone('Europe', 'Europa', 'Europa'));
        })->call($item12);
        ...
        (function () {
            ...
            $this->setName(new Name('Australia', 'Australia', 'Australia'));
            $this->setZone(new Zone('Oceania', 'Oceania', 'Oceania'));
        })->call($item13);
        ...
        (function () {
            ...
            $this->setName(new Name('Aruba', 'Aruba', 'Aruba'));
            $this->setZone(new Zone('North america', 'North america', 'North america'));
        })->call($item14);
        ...
        (function () {
            ...
            $this->setName(new Name('Åland Islands', 'Islas de Åland', 'Islas de Åland'));
            $this->setZone(new Zone('Europe', 'Europa', 'Europa'));
        })->call($item15);
        ...
        (function () {
            ...
            $this->setName(new Name('Azerbaijan', 'Azerbayán', 'Azerbayán'));
            $this->setZone(new Zone('Asia', 'Asia', 'Asia'));
        })->call($item16);
        ...
        (function () {
            ...
            $this->setName(new Name('Bosnia and Herzegovina', 'Bosnia y Herzegovina', 'Bosnia y Herzegovina'));
            $this->setZone(new Zone('Europe', 'Europa', 'Europa'));
        })->call($item17);
        ...
        (function () {
            ...
            $this->setName(new Name('Barbados', 'Barbados', 'Barbados'));
            $this->setZone(new Zone('North america', 'North america', 'North america'));
        })->call($item18);
        ...
        (function () {
            ...
            $this->setName(new Name('Bangladesh', 'Bangladesh', 'Bangladesh'));
            $this->setZone(new Zone('Asia', 'Asia', 'Asia'));
        })->call($item19);
        ...
        (function () {
            ...
            $this->setName(new Name('Belgium', 'Bélgica', 'Bélgica'));
            $this->setZone(new Zone('Europe', 'Europa', 'Europa'));
        })->call($item20);
        ...
        (function () {
            ...
            $this->setName(new Name('Burkina Faso', 'Burkina Faso', 'Burkina Faso'));
            $this->setZone(new Zone('Africa', 'Africa', 'Africa'));
        })->call($item21);
        ...
        (function () {
            ...
            $this->setName(new Name('Bulgaria', 'Bulgaria', 'Bulgaria'));
            $this->setZone(new Zone('Europe', 'Europa', 'Europa'));
        })->call($item22);
        ...
        (function () {
            ...
            $this->setName(new Name('Bahrain', 'Bahrein', 'Bahrein'));
            $this->setZone(new Zone('Asia', 'Asia', 'Asia'));
        })->call($item23);
        ...
        (function () {
            ...
            $this->setName(new Name('Burundi', 'Burundi', 'Burundi'));
            $this->setZone(new Zone('Africa', 'Africa', 'Africa'));
        })->call($item24);
        ...
        (function () {
            ...
            $this->setName(new Name('Benin', 'Benín', 'Benín'));
            $this->setZone(new Zone('Africa', 'Africa', 'Africa'));
        })->call($item25);
        ...
        (function () {
            ...
            $this->setName(new Name('Saint Barthélemy', 'San Bartolomé', 'San Bartolomé'));
            $this->setZone(new Zone('North america', 'North america', 'North america'));
        })->call($item26);
        ...
        (function () {
            ...
            $this->setName(new Name('Bermuda Islands', 'Islas Bermudas', 'Islas Bermudas'));
            $this->setZone(new Zone('North america', 'North america', 'North america'));
        })->call($item27);
        ...
        (function () {
            ...
            $this->setName(new Name('Brunei', 'Brunéi', 'Brunéi'));
            $this->setZone(new Zone('Asia', 'Asia', 'Asia'));
        })->call($item28);
        ...
        (function () {
            ...
            $this->setName(new Name('Bolivia', 'Bolivia', 'Bolivia'));
            $this->setZone(new Zone('South america', 'South america', 'South america'));
        })->call($item29);
        ...
        (function () {
            ...
            $this->setName(new Name('Bonaire', 'Bonaire', 'Bonaire'));
            $this->setZone(new Zone('South america', 'South america', 'South america'));
        })->call($item30);
        ...
        (function () {
            ...
            $this->setName(new Name('Brazil', 'Brasil', 'Brasil'));
            $this->setZone(new Zone('South america', 'South america', 'South america'));
        })->call($item31);
        ...
        (function () {
            ...
            $this->setName(new Name('Bahamas', 'Bahamas', 'Bahamas'));
            $this->setZone(new Zone('North america', 'North america', 'North america'));
        })->call($item32);
        ...
        (function () {
            ...
            $this->setName(new Name('Bhutan', 'Bhután', 'Bhután'));
            $this->setZone(new Zone('Asia', 'Asia', 'Asia'));
        })->call($item33);
        ...
        (function () {
            ...
            $this->setName(new Name('Bouvet Island', 'Isla Bouvet', 'Isla Bouvet'));
            $this->setZone(new Zone('Antarctica', 'Antarctica', 'Antarctica'));
        })->call($item34);
        ...
        (function () {
            ...
            $this->setName(new Name('Botswana', 'Botsuana', 'Botsuana'));
            $this->setZone(new Zone('Africa', 'Africa', 'Africa'));
        })->call($item35);
        ...
        (function () {
            ...
            $this->setName(new Name('Belarus', 'Bielorrusia', 'Bielorrusia'));
            $this->setZone(new Zone('Europe', 'Europa', 'Europa'));
        })->call($item36);
        ...
        (function () {
            ...
            $this->setName(new Name('Belize', 'Belice', 'Belice'));
            $this->setZone(new Zone('North america', 'North america', 'North america'));
        })->call($item37);
        ...
        (function () {
            ...
            $this->setName(new Name('Canada', 'Canadá', 'Canadá'));
            $this->setZone(new Zone('North america', 'North america', 'North america'));
        })->call($item38);
        ...
        (function () {
            $this->setCode("CC");
            $this->setCountryCode("+61");
            $this->setName(new Name('Cocos (Keeling) Islands', 'Islas Cocos (Keeling)', 'Islas Cocos (Keeling)'));
            $this->setZone(new Zone('Asia', 'Asia', 'Asia'));
        })->call($item39);
        ...
        (function () {
            ...
            $this->setName(new Name('Congo', 'Congo', 'Congo'));
            $this->setZone(new Zone('Africa', 'Africa', 'Africa'));
        })->call($item40);
        ...
        (function () {
            ...
            $this->setName(new Name('Central African Republic', 'República Centroafricana', 'República Centroafricana'));
            $this->setZone(new Zone('Africa', 'Africa', 'Africa'));
        })->call($item41);
        ...
        (function () {
            ...
            $this->setName(new Name('Switzerland', 'Suiza', 'Suiza'));
            $this->setZone(new Zone('Europe', 'Europa', 'Europa'));
        })->call($item43);
        ...
        (function () {
            ...
            $this->setName(new Name('Ivory Coast', 'Costa de Marfil', 'Costa de Marfil'));
            $this->setZone(new Zone('Africa', 'Africa', 'Africa'));
        })->call($item44);
        ...
        (function () {
            ...
            $this->setName(new Name('Cook Islands', 'Islas Cook', 'Islas Cook'));
            $this->setZone(new Zone('Oceania', 'Oceania', 'Oceania'));
        })->call($item45);
        ...
        (function () {
            ...
            $this->setName(new Name('Chile', 'Chile', 'Chile'));
            $this->setZone(new Zone('South america', 'South america', 'South america'));
        })->call($item46);
        ...
        (function () {
            ...
            $this->setName(new Name('Cameroon', 'Camerún', 'Camerún'));
            $this->setZone(new Zone('Africa', 'Africa', 'Africa'));
        })->call($item47);
        ...
        (function () {
            ...
            $this->setName(new Name('China', 'China', 'China'));
            $this->setZone(new Zone('Asia', 'Asia', 'Asia'));
        })->call($item48);
        ...
        (function () {
            ...
            $this->setName(new Name('Colombia', 'Colombia', 'Colombia'));
            $this->setZone(new Zone('South america', 'South america', 'South america'));
        })->call($item49);
        ...
        (function () {
            ...
            $this->setName(new Name('Costa Rica', 'Costa Rica', 'Costa Rica'));
            $this->setZone(new Zone('North america', 'North america', 'North america'));
        })->call($item50);
        ...
        (function () {
            ...
            $this->setName(new Name('Cuba', 'Cuba', 'Cuba'));
            $this->setZone(new Zone('North america', 'North america', 'North america'));
        })->call($item51);
        ...
        (function () {
            ...
            $this->setName(new Name('Cape Verde', 'Cabo Verde', 'Cabo Verde'));
            $this->setZone(new Zone('Africa', 'Africa', 'Africa'));
        })->call($item52);
        ...
        (function () {
            $this->setCode("CW");
            $this->setCountryCode("+599");
            $this->setName(new Name('Curaçao', 'Curaçao', 'Curaçao'));
            $this->setZone(new Zone('South america', 'South america', 'South america'));
        })->call($item53);
        ...
        (function () {
            $this->setCode("CX");
            $this->setCountryCode("+61");
            $this->setName(new Name('Christmas Island', 'Isla de Navidad', 'Isla de Navidad'));
            $this->setZone(new Zone('Asia', 'Asia', 'Asia'));
        })->call($item54);
        ...
        (function () {
            ...
            $this->setName(new Name('Cyprus', 'Chipre', 'Chipre'));
            $this->setZone(new Zone('Asia', 'Asia', 'Asia'));
        })->call($item55);
        ...
        (function () {
            ...
            $this->setName(new Name('Czech Republic', 'República Checa', 'República Checa'));
            $this->setZone(new Zone('Europe', 'Europa', 'Europa'));
        })->call($item56);
        ...
        (function () {
            ...
            $this->setName(new Name('Germany', 'Alemania', 'Alemania'));
            $this->setZone(new Zone('Europe', 'Europa', 'Europa'));
        })->call($item57);
        ...
        (function () {
            ...
            $this->setName(new Name('Djibouti', 'Yibuti', 'Yibuti'));
            $this->setZone(new Zone('Africa', 'Africa', 'Africa'));
        })->call($item58);
        ...
        (function () {
            ...
            $this->setName(new Name('Denmark', 'Dinamarca', 'Dinamarca'));
            $this->setZone(new Zone('Europe', 'Europa', 'Europa'));
        })->call($item59);
        ...
        (function () {
            ...
            $this->setName(new Name('Dominica', 'Dominica', 'Dominica'));
            $this->setZone(new Zone('North america', 'North america', 'North america'));
        })->call($item60);
        ...
        (function () {
            ...
            $this->setName(new Name('Dominican Republic', 'República Dominicana', 'República Dominicana'));
            $this->setZone(new Zone('North america', 'North america', 'North america'));
        })->call($item61);
        ...
        (function () {
            ...
            $this->setName(new Name('Algeria', 'Algeria', 'Algeria'));
            $this->setZone(new Zone('Africa', 'Africa', 'Africa'));
        })->call($item64);
        ...
        (function () {
            ...
            $this->setName(new Name('Ecuador', 'Ecuador', 'Ecuador'));
            $this->setZone(new Zone('South america', 'South america', 'South america'));
        })->call($item65);
        ...
        (function () {
            ...
            $this->setName(new Name('Estonia', 'Estonia', 'Estonia'));
            $this->setZone(new Zone('Europe', 'Europa', 'Europa'));
        })->call($item66);
        ...
        (function () {
            ...
            $this->setName(new Name('Egypt', 'Egipto', 'Egipto'));
            $this->setZone(new Zone('Africa', 'Africa', 'Africa'));
        })->call($item67);
        ...
        (function () {
            ...
            $this->setName(new Name('Western Sahara', 'Sahara Occidental', 'Sahara Occidental'));
            $this->setZone(new Zone('Africa', 'Africa', 'Africa'));
        })->call($item68);
        ...
        (function () {
            ...
            $this->setName(new Name('Eritrea', 'Eritrea', 'Eritrea'));
            $this->setZone(new Zone('Africa', 'Africa', 'Africa'));
        })->call($item69);
        ...
        (function () {
            ...
            $this->setName(new Name('Spain', 'España', 'España'));
            $this->setZone(new Zone('Europe', 'Europa', 'Europa'));
        })->call($item70);
        ...
        (function () {
            ...
            $this->setName(new Name('Ethiopia', 'Etiopía', 'Etiopía'));
            $this->setZone(new Zone('Africa', 'Africa', 'Africa'));
        })->call($item71);
        ...
        (function () {
            $this->setCode("FI");
            $this->setCountryCode("+358");
            $this->setName(new Name('Finland', 'Finlandia', 'Finlandia'));
            $this->setZone(new Zone('Europe', 'Europa', 'Europa'));
        })->call($item72);
        ...
        (function () {
            ...
            $this->setName(new Name('Fiji', 'Fiyi', 'Fiyi'));
            $this->setZone(new Zone('Oceania', 'Oceania', 'Oceania'));
        })->call($item73);
        ...
        (function () {
            ...
            $this->setName(new Name('Falkland Islands (Malvinas)', 'Islas Malvinas', 'Islas Malvinas'));
            $this->setZone(new Zone('South america', 'South america', 'South america'));
        })->call($item74);
        ...
        (function () {
            ...
            $this->setName(new Name('Estados Federados de', 'Micronesia', 'Micronesia'));
            $this->setZone(new Zone('Oceania', 'Oceania', 'Oceania'));
        })->call($item75);
        ...
        (function () {
            ...
            $this->setName(new Name('Faroe Islands', 'Islas Feroe', 'Islas Feroe'));
            $this->setZone(new Zone('Europe', 'Europa', 'Europa'));
        })->call($item76);
        ...
        (function () {
            ...
            $this->setName(new Name('France', 'Francia', 'Francia'));
            $this->setZone(new Zone('Europe', 'Europa', 'Europa'));
        })->call($item77);
        ...
        (function () {
            ...
            $this->setName(new Name('Gabon', 'Gabón', 'Gabón'));
            $this->setZone(new Zone('Africa', 'Africa', 'Africa'));
        })->call($item78);
        ...
        (function () {
            ...
            $this->setName(new Name('United Kingdom', 'Reino Unido', 'Reino Unido'));
            $this->setZone(new Zone('Europe', 'Europa', 'Europa'));
        })->call($item79);
        ...
        (function () {
            ...
            $this->setName(new Name('Grenada', 'Granada', 'Granada'));
            $this->setZone(new Zone('North america', 'North america', 'North america'));
        })->call($item80);
        ...
        (function () {
            ...
            $this->setName(new Name('Georgia', 'Georgia', 'Georgia'));
            $this->setZone(new Zone('Asia', 'Asia', 'Asia'));
        })->call($item81);
        ...
        (function () {
            ...
            $this->setName(new Name('French Guiana', 'Guayana Francesa', 'Guayana Francesa'));
            $this->setZone(new Zone('South america', 'South america', 'South america'));
        })->call($item82);
        ...
        (function () {
            $this->setCode("GG");
            $this->setCountryCode("+44");
            $this->setName(new Name('Guernsey', 'Guernsey', 'Guernsey'));
            $this->setZone(new Zone('Europe', 'Europa', 'Europa'));
        })->call($item83);
        ...
        (function () {
            ...
            $this->setName(new Name('Ghana', 'Ghana', 'Ghana'));
            $this->setZone(new Zone('Africa', 'Africa', 'Africa'));
        })->call($item84);
        ...
        (function () {
            ...
            $this->setName(new Name('Gibraltar', 'Gibraltar', 'Gibraltar'));
            $this->setZone(new Zone('Europe', 'Europa', 'Europa'));
        })->call($item85);
        ...
        (function () {
            ...
            $this->setName(new Name('Greenland', 'Groenlandia', 'Groenlandia'));
            $this->setZone(new Zone('North america', 'North america', 'North america'));
        })->call($item86);
        ...
        (function () {
            ...
            $this->setName(new Name('Gambia', 'Gambia', 'Gambia'));
            $this->setZone(new Zone('Africa', 'Africa', 'Africa'));
        })->call($item87);
        ...
        (function () {
            ...
            $this->setName(new Name('Guinea', 'Guinea', 'Guinea'));
            $this->setZone(new Zone('Africa', 'Africa', 'Africa'));
        })->call($item88);
        ...
        (function () {
            $this->setCode("GP");
            $this->setCountryCode("+590");
            $this->setName(new Name('Guadeloupe', 'Guadalupe', 'Guadalupe'));
            $this->setZone(new Zone('North america', 'North america', 'North america'));
        })->call($item89);
        ...
        (function () {
            ...
            $this->setName(new Name('Equatorial Guinea', 'Guinea Ecuatorial', 'Guinea Ecuatorial'));
            $this->setZone(new Zone('Africa', 'Africa', 'Africa'));
        })->call($item90);
        ...
        (function () {
            ...
            $this->setName(new Name('Greece', 'Grecia', 'Grecia'));
            $this->setZone(new Zone('Europe', 'Europa', 'Europa'));
        })->call($item91);
        ...
        (function () {
            $this->setCode("GS");
            $this->setCountryCode("+500");
            $this->setName(new Name('South Georgia and the South Sandwich Islands', 'Islas Georgias del Sur y Sandwich del Sur', 'Islas Georgias del Sur y Sandwich del Sur'));
            $this->setZone(new Zone('Antarctica', 'Antarctica', 'Antarctica'));
        })->call($item92);
        ...
        (function () {
            ...
            $this->setName(new Name('Guatemala', 'Guatemala', 'Guatemala'));
            $this->setZone(new Zone('North america', 'North america', 'North america'));
        })->call($item93);
        ...
        (function () {
            ...
            $this->setName(new Name('Guam', 'Guam', 'Guam'));
            $this->setZone(new Zone('Oceania', 'Oceania', 'Oceania'));
        })->call($item94);
        ...
        (function () {
            ...
            $this->setName(new Name('Guinea-Bissau', 'Guinea-Bissau', 'Guinea-Bissau'));
            $this->setZone(new Zone('Africa', 'Africa', 'Africa'));
        })->call($item95);
        ...
        (function () {
            ...
            $this->setName(new Name('Guyana', 'Guyana', 'Guyana'));
            $this->setZone(new Zone('South america', 'South america', 'South america'));
        })->call($item96);
        ...
        (function () {
            ...
            $this->setName(new Name('Hong Kong', 'Hong kong', 'Hong kong'));
            $this->setZone(new Zone('Asia', 'Asia', 'Asia'));
        })->call($item97);
        ...
        (function () {
            $this->setCode("HM");
            $this->setCountryCode("+672");
            $this->setName(new Name('Heard Island and McDonald Islands', 'Islas Heard y McDonald', 'Islas Heard y McDonald'));
            $this->setZone(new Zone('Antarctica', 'Antarctica', 'Antarctica'));
        })->call($item98);
        ...
        (function () {
            ...
            $this->setName(new Name('Honduras', 'Honduras', 'Honduras'));
            $this->setZone(new Zone('North america', 'North america', 'North america'));
        })->call($item99);
        ...
        (function () {
            ...
            $this->setName(new Name('Croatia', 'Croacia', 'Croacia'));
            $this->setZone(new Zone('Europe', 'Europa', 'Europa'));
        })->call($item100);
        ...
        (function () {
            ...
            $this->setName(new Name('Haiti', 'Haití', 'Haití'));
            $this->setZone(new Zone('North america', 'North america', 'North america'));
        })->call($item101);
        ...
        (function () {
            ...
            $this->setName(new Name('Hungary', 'Hungría', 'Hungría'));
            $this->setZone(new Zone('Europe', 'Europa', 'Europa'));
        })->call($item102);
        ...
        (function () {
            ...
            $this->setName(new Name('Indonesia', 'Indonesia', 'Indonesia'));
            $this->setZone(new Zone('Asia', 'Asia', 'Asia'));
        })->call($item103);
        ...
        (function () {
            ...
            $this->setName(new Name('Ireland', 'Irlanda', 'Irlanda'));
            $this->setZone(new Zone('Europe', 'Europa', 'Europa'));
        })->call($item104);
        ...
        (function () {
            ...
            $this->setName(new Name('Israel', 'Israel', 'Israel'));
            $this->setZone(new Zone('Asia', 'Asia', 'Asia'));
        })->call($item105);
        ...
        (function () {
            $this->setCode("IM");
            $this->setCountryCode("+44");
            $this->setName(new Name('Isle of Man', 'Isla de Man', 'Isla de Man'));
            $this->setZone(new Zone('Europe', 'Europa', 'Europa'));
        })->call($item106);
        ...
        (function () {
            ...
            $this->setName(new Name('India', 'India', 'India'));
            $this->setZone(new Zone('Asia', 'Asia', 'Asia'));
        })->call($item107);
        ...
        (function () {
            ...
            $this->setName(new Name('British Indian Ocean Territory', 'Territorio Británico del Océano Índico', 'Territorio Británico del Océano Índico'));
            $this->setZone(new Zone('Asia', 'Asia', 'Asia'));
        })->call($item108);
        ...
        (function () {
            ...
            $this->setName(new Name('Iraq', 'Irak', 'Irak'));
            $this->setZone(new Zone('Asia', 'Asia', 'Asia'));
        })->call($item109);
        ...
        (function () {
            ...
            $this->setName(new Name('Iran', 'Irán', 'Irán'));
            $this->setZone(new Zone('Asia', 'Asia', 'Asia'));
        })->call($item110);
        ...
        (function () {
            ...
            $this->setName(new Name('Iceland', 'Islandia', 'Islandia'));
            $this->setZone(new Zone('Europe', 'Europa', 'Europa'));
        })->call($item111);
        ...
        (function () {
            ...
            $this->setName(new Name('Italy', 'Italia', 'Italia'));
            $this->setZone(new Zone('Europe', 'Europa', 'Europa'));
        })->call($item112);
        ...
        (function () {
            $this->setCode("JE");
            $this->setCountryCode("+44");
            $this->setName(new Name('Jersey', 'Jersey', 'Jersey'));
            $this->setZone(new Zone('Europe', 'Europa', 'Europa'));
        })->call($item113);
        ...
        (function () {
            ...
            $this->setName(new Name('Jamaica', 'Jamaica', 'Jamaica'));
            $this->setZone(new Zone('North america', 'North america', 'North america'));
        })->call($item114);
        ...
        (function () {
            ...
            $this->setName(new Name('Jordan', 'Jordania', 'Jordania'));
            $this->setZone(new Zone('Asia', 'Asia', 'Asia'));
        })->call($item115);
        ...
        (function () {
            ...
            $this->setName(new Name('Japan', 'Japón', 'Japón'));
            $this->setZone(new Zone('Asia', 'Asia', 'Asia'));
        })->call($item116);
        ...
        (function () {
            ...
            $this->setName(new Name('Kenya', 'Kenia', 'Kenia'));
            $this->setZone(new Zone('Africa', 'Africa', 'Africa'));
        })->call($item117);
        ...
        (function () {
            ...
            $this->setName(new Name('Kyrgyzstan', 'Kirgizstán', 'Kirgizstán'));
            $this->setZone(new Zone('Asia', 'Asia', 'Asia'));
        })->call($item118);
        ...
        (function () {
            ...
            $this->setName(new Name('Cambodia', 'Camboya', 'Camboya'));
            $this->setZone(new Zone('Asia', 'Asia', 'Asia'));
        })->call($item119);
        ...
        (function () {
            ...
            $this->setName(new Name('Kiribati', 'Kiribati', 'Kiribati'));
            $this->setZone(new Zone('Oceania', 'Oceania', 'Oceania'));
        })->call($item120);
        ...
        (function () {
            ...
            $this->setName(new Name('Comoros', 'Comoras', 'Comoras'));
            $this->setZone(new Zone('Africa', 'Africa', 'Africa'));
        })->call($item121);
        ...
        (function () {
            ...
            $this->setName(new Name('Saint Kitts and Nevis', 'San Cristóbal y Nieves', 'San Cristóbal y Nieves'));
            $this->setZone(new Zone('North america', 'North america', 'North america'));
        })->call($item122);
        ...
        (function () {
            ...
            $this->setName(new Name('North Korea', 'Corea del Norte', 'Corea del Norte'));
            $this->setZone(new Zone('Asia', 'Asia', 'Asia'));
        })->call($item123);
        ...
        (function () {
            ...
            $this->setName(new Name('South Korea', 'Corea del Sur', 'Corea del Sur'));
            $this->setZone(new Zone('Asia', 'Asia', 'Asia'));
        })->call($item124);
        ...
        (function () {
            ...
            $this->setName(new Name('Kuwait', 'Kuwait', 'Kuwait'));
            $this->setZone(new Zone('Asia', 'Asia', 'Asia'));
        })->call($item125);
        ...
        (function () {
            ...
            $this->setName(new Name('Cayman Islands', 'Islas Caimán', 'Islas Caimán'));
            $this->setZone(new Zone('North america', 'North america', 'North america'));
        })->call($item126);
        ...
        (function () {
            ...
            $this->setName(new Name('Kazakhstan', 'Kazajistán', 'Kazajistán'));
            $this->setZone(new Zone('Asia', 'Asia', 'Asia'));
        })->call($item127);
        ...
        (function () {
            ...
            $this->setName(new Name('Laos', 'Laos', 'Laos'));
            $this->setZone(new Zone('Asia', 'Asia', 'Asia'));
        })->call($item128);
        ...
        (function () {
            ...
            $this->setName(new Name('Lebanon', 'Líbano', 'Líbano'));
            $this->setZone(new Zone('Asia', 'Asia', 'Asia'));
        })->call($item129);
        ...
        (function () {
            ...
            $this->setName(new Name('Saint Lucia', 'Santa Lucía', 'Santa Lucía'));
            $this->setZone(new Zone('North america', 'North america', 'North america'));
        })->call($item130);
        ...
        (function () {
            ...
            $this->setName(new Name('Liechtenstein', 'Liechtenstein', 'Liechtenstein'));
            $this->setZone(new Zone('Europe', 'Europa', 'Europa'));
        })->call($item131);
        ...
        (function () {
            ...
            $this->setName(new Name('Sri Lanka', 'Sri lanka', 'Sri lanka'));
            $this->setZone(new Zone('Asia', 'Asia', 'Asia'));
        })->call($item132);
        ...
        (function () {
            ...
            $this->setName(new Name('Liberia', 'Liberia', 'Liberia'));
            $this->setZone(new Zone('Africa', 'Africa', 'Africa'));
        })->call($item133);
        ...
        (function () {
            ...
            $this->setName(new Name('Lesotho', 'Lesoto', 'Lesoto'));
            $this->setZone(new Zone('Africa', 'Africa', 'Africa'));
        })->call($item134);
        ...
        (function () {
            ...
            $this->setName(new Name('Lithuania', 'Lituania', 'Lituania'));
            $this->setZone(new Zone('Europe', 'Europa', 'Europa'));
        })->call($item135);
        ...
        (function () {
            ...
            $this->setName(new Name('Luxembourg', 'Luxemburgo', 'Luxemburgo'));
            $this->setZone(new Zone('Europe', 'Europa', 'Europa'));
        })->call($item136);
        ...
        (function () {
            ...
            $this->setName(new Name('Latvia', 'Letonia', 'Letonia'));
            $this->setZone(new Zone('Europe', 'Europa', 'Europa'));
        })->call($item137);
        ...
        (function () {
            ...
            $this->setName(new Name('Libya', 'Libia', 'Libia'));
            $this->setZone(new Zone('Africa', 'Africa', 'Africa'));
        })->call($item138);
        ...
        (function () {
            $this->setCode("MA");
            $this->setCountryCode("+212");
            $this->setName(new Name('Morocco', 'Marruecos', 'Marruecos'));
            $this->setZone(new Zone('Africa', 'Africa', 'Africa'));
        })->call($item139);
        ...
        (function () {
            ...
            $this->setName(new Name('Monaco', 'Mónaco', 'Mónaco'));
            $this->setZone(new Zone('Europe', 'Europa', 'Europa'));
        })->call($item140);
        ...
        (function () {
            ...
            $this->setName(new Name('Moldova', 'Moldavia', 'Moldavia'));
            $this->setZone(new Zone('Europe', 'Europa', 'Europa'));
        })->call($item141);
        ...
        (function () {
            ...
            $this->setName(new Name('Montenegro', 'Montenegro', 'Montenegro'));
            $this->setZone(new Zone('Europe', 'Europa', 'Europa'));
        })->call($item142);
        ...
        (function () {
            ...
            $this->setName(new Name('Saint Martin (French part)', 'San Martín (Francia)', 'San Martín (Francia)'));
            $this->setZone(new Zone('North america', 'North america', 'North america'));
        })->call($item143);
        ...
        (function () {
            ...
            $this->setName(new Name('Madagascar', 'Madagascar', 'Madagascar'));
            $this->setZone(new Zone('Africa', 'Africa', 'Africa'));
        })->call($item144);
        ...
        (function () {
            ...
            $this->setName(new Name('Marshall Islands', 'Islas Marshall', 'Islas Marshall'));
            $this->setZone(new Zone('Oceania', 'Oceania', 'Oceania'));
        })->call($item145);
        ...
        (function () {
            ...
            $this->setName(new Name('Macedonia', 'Macedônia', 'Macedônia'));
            $this->setZone(new Zone('Europe', 'Europa', 'Europa'));
        })->call($item146);
        ...
        (function () {
            ...
            $this->setName(new Name('Mali', 'Mali', 'Mali'));
            $this->setZone(new Zone('Africa', 'Africa', 'Africa'));
        })->call($item147);
        ...
        (function () {
            ...
            $this->setName(new Name('Myanmar', 'Birmania', 'Birmania'));
            $this->setZone(new Zone('Asia', 'Asia', 'Asia'));
        })->call($item148);
        ...
        (function () {
            ...
            $this->setName(new Name('Mongolia', 'Mongolia', 'Mongolia'));
            $this->setZone(new Zone('Asia', 'Asia', 'Asia'));
        })->call($item149);
        ...
        (function () {
            ...
            $this->setName(new Name('Macao', 'Macao', 'Macao'));
            $this->setZone(new Zone('Asia', 'Asia', 'Asia'));
        })->call($item150);
        ...
        (function () {
            ...
            $this->setName(new Name('Northern Mariana Islands', 'Islas Marianas del Norte', 'Islas Marianas del Norte'));
            $this->setZone(new Zone('Oceania', 'Oceania', 'Oceania'));
        })->call($item151);
        ...
        (function () {
            ...
            $this->setName(new Name('Martinique', 'Martinica', 'Martinica'));
            $this->setZone(new Zone('North america', 'North america', 'North america'));
        })->call($item152);
        ...
        (function () {
            ...
            $this->setName(new Name('Mauritania', 'Mauritania', 'Mauritania'));
            $this->setZone(new Zone('Africa', 'Africa', 'Africa'));
        })->call($item153);
        ...
        (function () {
            ...
            $this->setName(new Name('Montserrat', 'Montserrat', 'Montserrat'));
            $this->setZone(new Zone('North america', 'North america', 'North america'));
        })->call($item154);
        ...
        (function () {
            ...
            $this->setName(new Name('Malta', 'Malta', 'Malta'));
            $this->setZone(new Zone('Europe', 'Europa', 'Europa'));
        })->call($item155);
        ...
        (function () {
            ...
            $this->setName(new Name('Mauritius', 'Mauricio', 'Mauricio'));
            $this->setZone(new Zone('Africa', 'Africa', 'Africa'));
        })->call($item156);
        ...
        (function () {
            ...
            $this->setName(new Name('Maldives', 'Islas Maldivas', 'Islas Maldivas'));
            $this->setZone(new Zone('Asia', 'Asia', 'Asia'));
        })->call($item157);
        ...
        (function () {
            ...
            $this->setName(new Name('Malawi', 'Malawi', 'Malawi'));
            $this->setZone(new Zone('Africa', 'Africa', 'Africa'));
        })->call($item158);
        ...
        (function () {
            ...
            $this->setName(new Name('Mexico', 'México', 'México'));
            $this->setZone(new Zone('North america', 'North america', 'North america'));
        })->call($item159);
        ...
        (function () {
            ...
            $this->setName(new Name('Malaysia', 'Malasia', 'Malasia'));
            $this->setZone(new Zone('Asia', 'Asia', 'Asia'));
        })->call($item160);
        ...
        (function () {
            ...
            $this->setName(new Name('Mozambique', 'Mozambique', 'Mozambique'));
            $this->setZone(new Zone('Africa', 'Africa', 'Africa'));
        })->call($item161);
        ...
        (function () {
            ...
            $this->setName(new Name('Namibia', 'Namibia', 'Namibia'));
            $this->setZone(new Zone('Africa', 'Africa', 'Africa'));
        })->call($item162);
        ...
        (function () {
            ...
            $this->setName(new Name('New Caledonia', 'Nueva Caledonia', 'Nueva Caledonia'));
            $this->setZone(new Zone('Oceania', 'Oceania', 'Oceania'));
        })->call($item163);
        ...
        (function () {
            ...
            $this->setName(new Name('Niger', 'Niger', 'Niger'));
            $this->setZone(new Zone('Africa', 'Africa', 'Africa'));
        })->call($item164);
        ...
        (function () {
            $this->setCode("NF");
            $this->setCountryCode("+672");
            $this->setName(new Name('Norfolk Island', 'Isla Norfolk', 'Isla Norfolk'));
            $this->setZone(new Zone('Oceania', 'Oceania', 'Oceania'));
        })->call($item165);
        ...
        (function () {
            ...
            $this->setName(new Name('Nigeria', 'Nigeria', 'Nigeria'));
            $this->setZone(new Zone('Africa', 'Africa', 'Africa'));
        })->call($item166);
        ...
        (function () {
            ...
            $this->setName(new Name('Nicaragua', 'Nicaragua', 'Nicaragua'));
            $this->setZone(new Zone('North america', 'North america', 'North america'));
        })->call($item167);
        ...
        (function () {
            ...
            $this->setName(new Name('Netherlands', 'Países Bajos', 'Países Bajos'));
            $this->setZone(new Zone('Europe', 'Europa', 'Europa'));
        })->call($item168);
        ...
        (function () {
            $this->setCode("NO");
            $this->setCountryCode("+47");
            $this->setName(new Name('Norway', 'Noruega', 'Noruega'));
            $this->setZone(new Zone('Europe', 'Europa', 'Europa'));
        })->call($item169);
        ...
        (function () {
            ...
            $this->setName(new Name('Nepal', 'Nepal', 'Nepal'));
            $this->setZone(new Zone('Asia', 'Asia', 'Asia'));
        })->call($item170);
        ...
        (function () {
            ...
            $this->setName(new Name('Nauru', 'Nauru', 'Nauru'));
            $this->setZone(new Zone('Oceania', 'Oceania', 'Oceania'));
        })->call($item171);
        ...
        (function () {
            ...
            $this->setName(new Name('Niue', 'Niue', 'Niue'));
            $this->setZone(new Zone('Oceania', 'Oceania', 'Oceania'));
        })->call($item172);
        ...
        (function () {
            ...
            $this->setName(new Name('New Zealand', 'Nueva Zelanda', 'Nueva Zelanda'));
            $this->setZone(new Zone('Oceania', 'Oceania', 'Oceania'));
        })->call($item173);
        ...
        (function () {
            ...
            $this->setName(new Name('Oman', 'Omán', 'Omán'));
            $this->setZone(new Zone('Asia', 'Asia', 'Asia'));
        })->call($item174);
        ...
        (function () {
            ...
            $this->setName(new Name('Panama', 'Panamá', 'Panamá'));
            $this->setZone(new Zone('North america', 'North america', 'North america'));
        })->call($item175);
        ...
        (function () {
            ...
            $this->setName(new Name('Peru', 'Perú', 'Perú'));
            $this->setZone(new Zone('South america', 'South america', 'South america'));
        })->call($item176);
        ...
        (function () {
            ...
            $this->setName(new Name('French Polynesia', 'Polinesia Francesa', 'Polinesia Francesa'));
            $this->setZone(new Zone('Oceania', 'Oceania', 'Oceania'));
        })->call($item177);
        ...
        (function () {
            ...
            $this->setName(new Name('Papua New Guinea', 'Papúa Nueva Guinea', 'Papúa Nueva Guinea'));
            $this->setZone(new Zone('Oceania', 'Oceania', 'Oceania'));
        })->call($item178);
        ...
        (function () {
            ...
            $this->setName(new Name('Philippines', 'Filipinas', 'Filipinas'));
            $this->setZone(new Zone('Asia', 'Asia', 'Asia'));
        })->call($item179);
        ...
        (function () {
            ...
            $this->setName(new Name('Pakistan', 'Pakistán', 'Pakistán'));
            $this->setZone(new Zone('Asia', 'Asia', 'Asia'));
        })->call($item180);
        ...
        (function () {
            ...
            $this->setName(new Name('Poland', 'Polonia', 'Polonia'));
            $this->setZone(new Zone('Europe', 'Europa', 'Europa'));
        })->call($item181);
        ...
        (function () {
            ...
            $this->setName(new Name('Saint Pierre and Miquelon', 'San Pedro y Miquelón', 'San Pedro y Miquelón'));
            $this->setZone(new Zone('North america', 'North america', 'North america'));
        })->call($item182);
        ...
        (function () {
            ...
            $this->setName(new Name('Pitcairn Islands', 'Islas Pitcairn', 'Islas Pitcairn'));
            $this->setZone(new Zone('Oceania', 'Oceania', 'Oceania'));
        })->call($item183);
        ...
        (function () {
            $this->setCode("PR");
            $this->setCountryCode("+1");
            $this->setName(new Name('Puerto Rico', 'Puerto Rico', 'Puerto Rico'));
            $this->setZone(new Zone('North america', 'North america', 'North america'));
        })->call($item184);
        ...
        (function () {
            ...
            $this->setName(new Name('Palestine', 'Palestina', 'Palestina'));
            $this->setZone(new Zone('Asia', 'Asia', 'Asia'));
        })->call($item185);
        ...
        (function () {
            ...
            $this->setName(new Name('Portugal', 'Portugal', 'Portugal'));
            $this->setZone(new Zone('Europe', 'Europa', 'Europa'));
        })->call($item186);
        ...
        (function () {
            ...
            $this->setName(new Name('Palau', 'Palau', 'Palau'));
            $this->setZone(new Zone('Oceania', 'Oceania', 'Oceania'));
        })->call($item187);
        ...
        (function () {
            ...
            $this->setName(new Name('Paraguay', 'Paraguay', 'Paraguay'));
            $this->setZone(new Zone('South america', 'South america', 'South america'));
        })->call($item188);
        ...
        (function () {
            ...
            $this->setName(new Name('Qatar', 'Qatar', 'Qatar'));
            $this->setZone(new Zone('Asia', 'Asia', 'Asia'));
        })->call($item189);
        ...
        (function () {
            ...
            $this->setName(new Name('Réunion', 'Reunión', 'Reunión'));
            $this->setZone(new Zone('Africa', 'Africa', 'Africa'));
        })->call($item190);
        ...
        (function () {
            ...
            $this->setName(new Name('Romania', 'Rumanía', 'Rumanía'));
            $this->setZone(new Zone('Europe', 'Europa', 'Europa'));
        })->call($item191);
        ...
        (function () {
            ...
            $this->setName(new Name('Serbia', 'Serbia', 'Serbia'));
            $this->setZone(new Zone('Europe', 'Europa', 'Europa'));
        })->call($item192);
        ...
        (function () {
            $this->setCode("RU");
            $this->setCountryCode("+7");
            $this->setName(new Name('Russia', 'Rusia', 'Rusia'));
            $this->setZone(new Zone('Europe', 'Europa', 'Europa'));
        })->call($item193);
        ...
        (function () {
            ...
            $this->setName(new Name('Rwanda', 'Ruanda', 'Ruanda'));
            $this->setZone(new Zone('Africa', 'Africa', 'Africa'));
        })->call($item194);
        ...
        (function () {
            ...
            $this->setName(new Name('Saudi Arabia', 'Arabia Saudita', 'Arabia Saudita'));
            $this->setZone(new Zone('Asia', 'Asia', 'Asia'));
        })->call($item195);
        ...
        (function () {
            ...
            $this->setName(new Name('Solomon Islands', 'Islas Salomón', 'Islas Salomón'));
            $this->setZone(new Zone('Oceania', 'Oceania', 'Oceania'));
        })->call($item196);
        ...
        (function () {
            ...
            $this->setName(new Name('Seychelles', 'Seychelles', 'Seychelles'));
            $this->setZone(new Zone('Africa', 'Africa', 'Africa'));
        })->call($item197);
        ...
        (function () {
            ...
            $this->setName(new Name('Sudan', 'Sudán', 'Sudán'));
            $this->setZone(new Zone('Africa', 'Africa', 'Africa'));
        })->call($item198);
        ...
        (function () {
            ...
            $this->setName(new Name('Sweden', 'Suecia', 'Suecia'));
            $this->setZone(new Zone('Europe', 'Europa', 'Europa'));
        })->call($item199);
        ...
        (function () {
            ...
            $this->setName(new Name('Singapore', 'Singapur', 'Singapur'));
            $this->setZone(new Zone('Asia', 'Asia', 'Asia'));
        })->call($item200);
        ...
        (function () {
            ...
            $this->setName(new Name('Ascensión y Tristán de Acuña', 'Santa Elena', 'Santa Elena'));
            $this->setZone(new Zone('Africa', 'Africa', 'Africa'));
        })->call($item201);
        ...
        (function () {
            ...
            $this->setName(new Name('Slovenia', 'Eslovenia', 'Eslovenia'));
            $this->setZone(new Zone('Europe', 'Europa', 'Europa'));
        })->call($item202);
        ...
        (function () {
            $this->setCode("SJ");
            $this->setCountryCode("+47");
            $this->setName(new Name('Svalbard and Jan Mayen', 'Svalbard y Jan Mayen', 'Svalbard y Jan Mayen'));
            $this->setZone(new Zone('Europe', 'Europa', 'Europa'));
        })->call($item203);
        ...
        (function () {
            ...
            $this->setName(new Name('Slovakia', 'Eslovaquia', 'Eslovaquia'));
            $this->setZone(new Zone('Europe', 'Europa', 'Europa'));
        })->call($item204);
        ...
        (function () {
            ...
            $this->setName(new Name('Sierra Leone', 'Sierra Leona', 'Sierra Leona'));
            $this->setZone(new Zone('Africa', 'Africa', 'Africa'));
        })->call($item205);
        ...
        (function () {
            ...
            $this->setName(new Name('San Marino', 'San Marino', 'San Marino'));
            $this->setZone(new Zone('Europe', 'Europa', 'Europa'));
        })->call($item206);
        ...
        (function () {
            ...
            $this->setName(new Name('Senegal', 'Senegal', 'Senegal'));
            $this->setZone(new Zone('Africa', 'Africa', 'Africa'));
        })->call($item207);
        ...
        (function () {
            ...
            $this->setName(new Name('Somalia', 'Somalia', 'Somalia'));
            $this->setZone(new Zone('Africa', 'Africa', 'Africa'));
        })->call($item208);
        ...
        (function () {
            ...
            $this->setName(new Name('Suriname', 'Surinám', 'Surinám'));
            $this->setZone(new Zone('South america', 'South america', 'South america'));
        })->call($item209);
        ...
        (function () {
            ...
            $this->setName(new Name('South Sudan', 'Sudán del Sur', 'Sudán del Sur'));
            $this->setZone(new Zone('Africa', 'Africa', 'Africa'));
        })->call($item210);
        ...
        (function () {
            ...
            $this->setName(new Name('Sao Tome and Principe', 'Santo Tomé y Príncipe', 'Santo Tomé y Príncipe'));
            $this->setZone(new Zone('Africa', 'Africa', 'Africa'));
        })->call($item211);
        ...
        (function () {
            ...
            $this->setName(new Name('El Salvador', 'El Salvador', 'El Salvador'));
            $this->setZone(new Zone('North america', 'North america', 'North america'));
        })->call($item212);
        ...
        (function () {
            ...
            $this->setName(new Name('Sint Maarten (Dutch part)', 'Sint Maarten (parte neerlandesa)', 'Sint Maarten (parte neerlandesa)'));
            $this->setZone(new Zone('North america', 'North america', 'North america'));
        })->call($item213);
        ...
        (function () {
            ...
            $this->setName(new Name('Syria', 'Siria', 'Siria'));
            $this->setZone(new Zone('Asia', 'Asia', 'Asia'));
        })->call($item214);
        ...
        (function () {
            ...
            $this->setName(new Name('Swaziland', 'Swazilandia', 'Swazilandia'));
            $this->setZone(new Zone('Africa', 'Africa', 'Africa'));
        })->call($item215);
        ...
        (function () {
            ...
            $this->setName(new Name('Turks and Caicos Islands', 'Islas Turcas y Caicos', 'Islas Turcas y Caicos'));
            $this->setZone(new Zone('North america', 'North america', 'North america'));
        })->call($item216);
        ...
        (function () {
            ...
            $this->setName(new Name('Chad', 'Chad', 'Chad'));
            $this->setZone(new Zone('Africa', 'Africa', 'Africa'));
        })->call($item217);
        ...
        (function () {
            $this->setCode("TF");
            $this->setCountryCode("+262");
            $this->setName(new Name('French Southern Territories', 'Territorios Australes y Antárticas Franceses', 'Territorios Australes y Antárticas Franceses'));
            $this->setZone(new Zone('Antarctica', 'Antarctica', 'Antarctica'));
        })->call($item218);
        ...
        (function () {
            ...
            $this->setName(new Name('Togo', 'Togo', 'Togo'));
            $this->setZone(new Zone('Africa', 'Africa', 'Africa'));
        })->call($item219);
        ...
        (function () {
            ...
            $this->setName(new Name('Thailand', 'Tailandia', 'Tailandia'));
            $this->setZone(new Zone('Asia', 'Asia', 'Asia'));
        })->call($item220);
        ...
        (function () {
            ...
            $this->setName(new Name('Tajikistan', 'Tadjikistán', 'Tadjikistán'));
            $this->setZone(new Zone('Asia', 'Asia', 'Asia'));
        })->call($item221);
        ...
        (function () {
            ...
            $this->setName(new Name('Tokelau', 'Tokelau', 'Tokelau'));
            $this->setZone(new Zone('Oceania', 'Oceania', 'Oceania'));
        })->call($item222);
        ...
        (function () {
            ...
            $this->setName(new Name('East Timor', 'Timor Oriental', 'Timor Oriental'));
            $this->setZone(new Zone('Asia', 'Asia', 'Asia'));
        })->call($item223);
        ...
        (function () {
            ...
            $this->setName(new Name('Turkmenistan', 'Turkmenistán', 'Turkmenistán'));
            $this->setZone(new Zone('Asia', 'Asia', 'Asia'));
        })->call($item224);
        ...
        (function () {
            ...
            $this->setName(new Name('Tunisia', 'Tunez', 'Tunez'));
            $this->setZone(new Zone('Africa', 'Africa', 'Africa'));
        })->call($item225);
        ...
        (function () {
            ...
            $this->setName(new Name('Tonga', 'Tonga', 'Tonga'));
            $this->setZone(new Zone('Oceania', 'Oceania', 'Oceania'));
        })->call($item226);
        ...
        (function () {
            ...
            $this->setName(new Name('Turkey', 'Turquía', 'Turquía'));
            $this->setZone(new Zone('Europe', 'Europa', 'Europa'));
        })->call($item227);
        ...
        (function () {
            ...
            $this->setName(new Name('Trinidad and Tobago', 'Trinidad y Tobago', 'Trinidad y Tobago'));
            $this->setZone(new Zone('North america', 'North america', 'North america'));
        })->call($item228);
        ...
        (function () {
            ...
            $this->setName(new Name('Tuvalu', 'Tuvalu', 'Tuvalu'));
            $this->setZone(new Zone('Oceania', 'Oceania', 'Oceania'));
        })->call($item229);
        ...
        (function () {
            ...
            $this->setName(new Name('Taiwan', 'Taiwán', 'Taiwán'));
            $this->setZone(new Zone('Asia', 'Asia', 'Asia'));
        })->call($item230);
        ...
        (function () {
            ...
            $this->setName(new Name('Tanzania', 'Tanzania', 'Tanzania'));
            $this->setZone(new Zone('Africa', 'Africa', 'Africa'));
        })->call($item231);
        ...
        (function () {
            ...
            $this->setName(new Name('Ukraine', 'Ucrania', 'Ucrania'));
            $this->setZone(new Zone('Europe', 'Europa', 'Europa'));
        })->call($item232);
        ...
        (function () {
            ...
            $this->setName(new Name('Uganda', 'Uganda', 'Uganda'));
            $this->setZone(new Zone('Africa', 'Africa', 'Africa'));
        })->call($item233);
        ...
        (function () {
            $this->setCode("UM");
            $this->setCountryCode("+1");
            $this->setName(new Name('United States Minor Outlying Islands', 'Islas Ultramarinas Menores de Estados Unidos', 'Islas Ultramarinas Menores de Estados Unidos'));
            $this->setZone(new Zone('Oceania', 'Oceania', 'Oceania'));
        })->call($item234);
        ...
        (function () {
            $this->setCode("US");
            $this->setCountryCode("+1");
            $this->setName(new Name('United States of America', 'Estados Unidos de América', 'Estados Unidos de América'));
            $this->setZone(new Zone('North america', 'North america', 'North america'));
        })->call($item235);
        ...
        (function () {
            ...
            $this->setName(new Name('Uruguay', 'Uruguay', 'Uruguay'));
            $this->setZone(new Zone('South america', 'South america', 'South america'));
        })->call($item236);
        ...
        (function () {
            ...
            $this->setName(new Name('Uzbekistan', 'Uzbekistán', 'Uzbekistán'));
            $this->setZone(new Zone('Asia', 'Asia', 'Asia'));
        })->call($item237);
        ...
        (function () {
            $this->setCode("VA");
            $this->setCountryCode("+39");
            $this->setName(new Name('Vatican City State', 'Ciudad del Vaticano', 'Ciudad del Vaticano'));
            $this->setZone(new Zone('Europe', 'Europa', 'Europa'));
        })->call($item238);
        ...
        (function () {
            ...
            $this->setName(new Name('Saint Vincent and the Grenadines', 'San Vicente y las Granadinas', 'San Vicente y las Granadinas'));
            $this->setZone(new Zone('North america', 'North america', 'North america'));
        })->call($item239);
        ...
        (function () {
            ...
            $this->setName(new Name('Venezuela', 'Venezuela', 'Venezuela'));
            $this->setZone(new Zone('South america', 'South america', 'South america'));
        })->call($item240);
        ...
        (function () {
            ...
            $this->setName(new Name('Virgin Islands', 'Islas Vírgenes Británicas', 'Islas Vírgenes Británicas'));
            $this->setZone(new Zone('North america', 'North america', 'North america'));
        })->call($item241);
        ...
        (function () {
            ...
            $this->setName(new Name('United States Virgin Islands', 'Islas Vírgenes de los Estados Unidos', 'Islas Vírgenes de los Estados Unidos'));
            $this->setZone(new Zone('North america', 'North america', 'North america'));
        })->call($item242);
        ...
        (function () {
            ...
            $this->setName(new Name('Vietnam', 'Vietnam', 'Vietnam'));
            $this->setZone(new Zone('Asia', 'Asia', 'Asia'));
        })->call($item243);
        ...
        (function () {
            ...
            $this->setName(new Name('Vanuatu', 'Vanuatu', 'Vanuatu'));
            $this->setZone(new Zone('Oceania', 'Oceania', 'Oceania'));
        })->call($item244);
        ...
        (function () {
            ...
            $this->setName(new Name('Wallis and Futuna', 'Wallis y Futuna', 'Wallis y Futuna'));
            $this->setZone(new Zone('Oceania', 'Oceania', 'Oceania'));
        })->call($item245);
        ...
        (function () {
            ...
            $this->setName(new Name('Samoa', 'Samoa', 'Samoa'));
            $this->setZone(new Zone('Oceania', 'Oceania', 'Oceania'));
        })->call($item246);
        ...
        (function () {
            ...
            $this->setName(new Name('Yemen', 'Yemen', 'Yemen'));
            $this->setZone(new Zone('Asia', 'Asia', 'Asia'));
        })->call($item247);
        ...
        (function () {
            $this->setCode("YT");
            $this->setCountryCode("+262");
            $this->setName(new Name('Mayotte', 'Mayotte', 'Mayotte'));
            $this->setZone(new Zone('Africa', 'Africa', 'Africa'));
        })->call($item248);
        ...
        (function () {
            ...
            $this->setName(new Name('South Africa', 'Sudáfrica', 'Sudáfrica'));
            $this->setZone(new Zone('Africa', 'Africa', 'Africa'));
        })->call($item249);
        ...
        (function () {
            ...
            $this->setName(new Name('Zambia', 'Zambia', 'Zambia'));
            $this->setZone(new Zone('Africa', 'Africa', 'Africa'));
        })->call($item250);
        ...
        (function () {
            ...
            $this->setName(new Name('Zimbabwe', 'Zimbabue', 'Zimbabue'));
            $this->setZone(new Zone('Africa', 'Africa', 'Africa'));
        })->call($item251);
