...
class KamTrunksCdr extends Fixture implements DependentFixtureInterface
{
    ...
    public function load(ObjectManager $manager)
    {
        ...
        (function () use ($fixture) {
            $this->startTime = new \DateTime('2021-11-22 16:54:49');
            $this->endTime = new \DateTime('2021-11-22 16:54:54');
            $this->setDuration(4.765);
            $this->setDirection('outbound');
        ...
        (function () use ($fixture) {
            $this->startTime = new \DateTime('2021-11-22 17:55:49');
            $this->endTime = new \DateTime('2021-11-22 17:55:54');
