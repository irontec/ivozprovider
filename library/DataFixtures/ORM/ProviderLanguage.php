...
class ProviderLanguage extends Fixture
{
    ...
    public function load(ObjectManager $manager)
    {
        ...
        (function () use ($fixture) {
            $this->setIden("es");
            $this->name = new Name('es', 'es', 'es', 'es', 'es');
        })->call($item1);
        ...
        (function () use ($fixture) {
            $this->setIden("en");
            $this->name = new Name('en', 'en', 'en', 'en', 'en');
        })->call($item2);
        ...
        (function () use ($fixture) {
            $this->setIden("ca");
            $this->name = new Name('ca', 'ca', 'ca', 'ca', 'ca');
        })->call($item3);
        ...
        (function () use ($fixture) {
            $this->setIden("it");
            $this->name = new Name('it', 'it', 'it', 'it', 'it');
        })->call($item4);
        ...
        $item5 = $this->createEntityInstance(Language::class);
        (function () use ($fixture) {
            $this->setIden("eu");
            $this->name = new Name('eu', 'eu', 'eu', 'eu', 'eu');
        })->call($item5);

        $this->addReference('_reference_ProviderLanguage5', $item5);
