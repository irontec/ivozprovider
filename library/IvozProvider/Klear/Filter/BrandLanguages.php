<?php
class IvozProvider_Klear_Filter_BrandLanguages implements KlearMatrix_Model_Field_Select_Filter_Interface
{
    ...
    public function setRouteDispatcher(KlearMatrix_Model_RouteDispatcher $routeDispatcher)
    {
        ...
        $brandsRelLanguagesMapper = new \IvozProvider\Mapper\Sql\BrandsRelLanguages();
