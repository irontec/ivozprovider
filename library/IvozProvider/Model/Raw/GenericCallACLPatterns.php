...
class GenericCallACLPatterns extends ModelAbstract
{
    ...
    /**
     * Parent relation GenericCallACLPatterns_ibfk_1
     *
    ...
    ***************************************************************************/
     ...
     * @param int $data
     * @return \IvozProvider\Model\Raw\GenericCallACLPatterns
     */
     ...
     *
     * @return IvozProvider\Mapper\Sql\GenericCallACLPatterns
     */
    public function getMapper()
    {
        if ($this->_mapper === null) {
            ...
            if (class_exists('\IvozProvider\Mapper\Sql\GenericCallACLPatterns')) {

                $this->setMapper(new \IvozProvider\Mapper\Sql\GenericCallACLPatterns);
     ...
     *
     * @return null | \IvozProvider\Model\Validator\GenericCallACLPatterns
     */
    public function getValidator()
    {
        if ($this->_validator === null) {

            if (class_exists('\IvozProvider\\Validator\GenericCallACLPatterns')) {

                $this->setValidator(new \IvozProvider\Validator\GenericCallACLPatterns);
            }
        }
     ...
     *
     * @see \Mapper\Sql\GenericCallACLPatterns::delete
