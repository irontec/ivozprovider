...
class MainOperators extends ModelAbstract
{
    ...
    ***************************************************************************/
     ...
     * @param int $data
     * @return \IvozProvider\Model\Raw\MainOperators
     */
     ...
     *
     * @return IvozProvider\Mapper\Sql\MainOperators
     */
    public function getMapper()
    {
        if ($this->_mapper === null) {
            ...
            if (class_exists('\IvozProvider\Mapper\Sql\MainOperators')) {

                $this->setMapper(new \IvozProvider\Mapper\Sql\MainOperators);
     ...
     *
     * @return null | \IvozProvider\Model\Validator\MainOperators
     */
    public function getValidator()
    {
        if ($this->_validator === null) {

            if (class_exists('\IvozProvider\\Validator\MainOperators')) {

                $this->setValidator(new \IvozProvider\Validator\MainOperators);
            }
        }
