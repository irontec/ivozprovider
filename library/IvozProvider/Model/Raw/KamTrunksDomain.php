...
class KamTrunksDomain extends ModelAbstract
{
    ...
    /**
     * Parent relation kam_trunks_domain_ibfk_1
     *
    ...
    ***************************************************************************/
     ...
     * @param int $data
     * @return \IvozProvider\Model\Raw\KamTrunksDomain
     */
     ...
     *
     * @return IvozProvider\Mapper\Sql\KamTrunksDomain
     */
    public function getMapper()
    {
        if ($this->_mapper === null) {
            ...
            if (class_exists('\IvozProvider\Mapper\Sql\KamTrunksDomain')) {

                $this->setMapper(new \IvozProvider\Mapper\Sql\KamTrunksDomain);
     ...
     *
     * @return null | \IvozProvider\Model\Validator\KamTrunksDomain
     */
    public function getValidator()
    {
        if ($this->_validator === null) {

            if (class_exists('\IvozProvider\\Validator\KamTrunksDomain')) {

                $this->setValidator(new \IvozProvider\Validator\KamTrunksDomain);
            }
        }
     ...
     *
     * @see \Mapper\Sql\KamTrunksDomain::delete
