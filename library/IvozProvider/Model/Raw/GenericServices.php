...
class GenericServices extends ModelAbstract
{
    ...
    ***************************************************************************/
     ...
     * @param int $data
     * @return \IvozProvider\Model\Raw\GenericServices
     */
     ...
     *
     * @return IvozProvider\Mapper\Sql\GenericServices
     */
    public function getMapper()
    {
        if ($this->_mapper === null) {
            ...
            if (class_exists('\IvozProvider\Mapper\Sql\GenericServices')) {

                $this->setMapper(new \IvozProvider\Mapper\Sql\GenericServices);
     ...
     *
     * @return null | \IvozProvider\Model\Validator\GenericServices
     */
    public function getValidator()
    {
        if ($this->_validator === null) {

            if (class_exists('\IvozProvider\\Validator\GenericServices')) {

                $this->setValidator(new \IvozProvider\Validator\GenericServices);
            }
        }
