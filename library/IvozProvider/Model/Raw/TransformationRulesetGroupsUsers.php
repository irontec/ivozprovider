...
class TransformationRulesetGroupsUsers extends ModelAbstract
{
    ...
    ***************************************************************************/
     ...
     *
     * @return IvozProvider\Mapper\Sql\TransformationRulesetGroupsUsers
     */
    public function getMapper()
    {
        if ($this->_mapper === null) {
            ...
            if (class_exists('\IvozProvider\Mapper\Sql\TransformationRulesetGroupsUsers')) {

                $this->setMapper(new \IvozProvider\Mapper\Sql\TransformationRulesetGroupsUsers);
     ...
     *
     * @return null | \IvozProvider\Model\Validator\TransformationRulesetGroupsUsers
     */
    public function getValidator()
    {
        if ($this->_validator === null) {

            if (class_exists('\IvozProvider\\Validator\TransformationRulesetGroupsUsers')) {

                $this->setValidator(new \IvozProvider\Validator\TransformationRulesetGroupsUsers);
            }
        }
