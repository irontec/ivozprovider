...
class InvoiceTemplates extends ModelAbstract
{
    ...
    /**
     * Parent relation InvoiceTemplates_ibfk_1
     *
    ...
    /**
     * Dependent relation Invoices_ibfk_4
    ...
    ***************************************************************************/
    ...
    public function setTemplate($data)
    {
        ...
        if ($this->_template != $data) {
            $this->_logChange('template', $this->_template, $data);
        }
    ...
    /**
     * Sets dependent relations Invoices_ibfk_4
     *
    ...
    /**
     * Gets dependent Invoices_ibfk_4
     *
     ...
     *
     * @return IvozProvider\Mapper\Sql\InvoiceTemplates
     */
    public function getMapper()
    {
        if ($this->_mapper === null) {
            ...
            if (class_exists('\IvozProvider\Mapper\Sql\InvoiceTemplates')) {

                $this->setMapper(new \IvozProvider\Mapper\Sql\InvoiceTemplates);
     ...
     *
     * @return null | \IvozProvider\Model\Validator\InvoiceTemplates
     */
    public function getValidator()
    {
        if ($this->_validator === null) {

            if (class_exists('\IvozProvider\\Validator\InvoiceTemplates')) {

                $this->setValidator(new \IvozProvider\Validator\InvoiceTemplates);
            }
        }
     ...
     *
     * @see \Mapper\Sql\InvoiceTemplates::delete
