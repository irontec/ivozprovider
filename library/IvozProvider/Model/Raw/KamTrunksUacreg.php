...
class KamTrunksUacreg extends ModelAbstract
{
    ...
    ***************************************************************************/
     ...
     *
     * @return IvozProvider\Mapper\Sql\KamTrunksUacreg
     */
    public function getMapper()
    {
        if ($this->_mapper === null) {
            ...
            if (class_exists('\IvozProvider\Mapper\Sql\KamTrunksUacreg')) {

                $this->setMapper(new \IvozProvider\Mapper\Sql\KamTrunksUacreg);
     ...
     *
     * @return null | \IvozProvider\Model\Validator\KamTrunksUacreg
     */
    public function getValidator()
    {
        if ($this->_validator === null) {

            if (class_exists('\IvozProvider\\Validator\KamTrunksUacreg')) {

                $this->setValidator(new \IvozProvider\Validator\KamTrunksUacreg);
            }
        }
