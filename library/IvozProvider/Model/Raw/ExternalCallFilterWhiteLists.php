...
class ExternalCallFilterWhiteLists extends ModelAbstract
{
    ...
    /**
     * Parent relation ExternalCallFilterWhiteLists_ibfk_1
     *
    ...
    /**
     * Parent relation ExternalCallFilterWhiteLists_ibfk_2
     *
    ...
    ***************************************************************************/
     ...
     * @param int $data
     * @return \IvozProvider\Model\Raw\ExternalCallFilterWhiteLists
     */
     ...
     *
     * @return IvozProvider\Mapper\Sql\ExternalCallFilterWhiteLists
     */
    public function getMapper()
    {
        if ($this->_mapper === null) {
            ...
            if (class_exists('\IvozProvider\Mapper\Sql\ExternalCallFilterWhiteLists')) {

                $this->setMapper(new \IvozProvider\Mapper\Sql\ExternalCallFilterWhiteLists);
     ...
     *
     * @return null | \IvozProvider\Model\Validator\ExternalCallFilterWhiteLists
     */
    public function getValidator()
    {
        if ($this->_validator === null) {

            if (class_exists('\IvozProvider\\Validator\ExternalCallFilterWhiteLists')) {

                $this->setValidator(new \IvozProvider\Validator\ExternalCallFilterWhiteLists);
            }
        }
     ...
     *
     * @see \Mapper\Sql\ExternalCallFilterWhiteLists::delete
