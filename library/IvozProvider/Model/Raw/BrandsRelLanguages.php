...
class BrandsRelLanguages extends ModelAbstract
{
    ...
    ***************************************************************************/
     ...
     *
     * @return IvozProvider\Mapper\Sql\BrandsRelLanguages
     */
    public function getMapper()
    {
        if ($this->_mapper === null) {
            ...
            if (class_exists('\IvozProvider\Mapper\Sql\BrandsRelLanguages')) {

                $this->setMapper(new \IvozProvider\Mapper\Sql\BrandsRelLanguages);
     ...
     *
     * @return null | \IvozProvider\Model\Validator\BrandsRelLanguages
     */
    public function getValidator()
    {
        if ($this->_validator === null) {

            if (class_exists('\IvozProvider\\Validator\BrandsRelLanguages')) {

                $this->setValidator(new \IvozProvider\Validator\BrandsRelLanguages);
            }
        }
