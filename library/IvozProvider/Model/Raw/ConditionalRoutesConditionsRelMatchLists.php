...
class ConditionalRoutesConditionsRelMatchLists extends ModelAbstract
{
    ...
    /**
     * Parent relation ConditionalRoutesConditionsRelMatchLists_ibfk_1
     *
    ...
    /**
     * Parent relation ConditionalRoutesConditionsRelMatchLists_ibfk_2
     *
    ...
    ***************************************************************************/
     ...
     * @param int $data
     * @return \IvozProvider\Model\Raw\ConditionalRoutesConditionsRelMatchLists
     */
     ...
     *
     * @return IvozProvider\Mapper\Sql\ConditionalRoutesConditionsRelMatchLists
     */
    public function getMapper()
    {
        if ($this->_mapper === null) {
            ...
            if (class_exists('\IvozProvider\Mapper\Sql\ConditionalRoutesConditionsRelMatchLists')) {

                $this->setMapper(new \IvozProvider\Mapper\Sql\ConditionalRoutesConditionsRelMatchLists);
     ...
     *
     * @return null | \IvozProvider\Model\Validator\ConditionalRoutesConditionsRelMatchLists
     */
    public function getValidator()
    {
        if ($this->_validator === null) {

            if (class_exists('\IvozProvider\\Validator\ConditionalRoutesConditionsRelMatchLists')) {

                $this->setValidator(new \IvozProvider\Validator\ConditionalRoutesConditionsRelMatchLists);
            }
        }
     ...
     *
     * @see \Mapper\Sql\ConditionalRoutesConditionsRelMatchLists::delete
