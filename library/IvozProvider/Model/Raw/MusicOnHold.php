...
class MusicOnHold extends ModelAbstract
{
    ...
    ***************************************************************************/
     ...
     * @param int $data
     * @return \IvozProvider\Model\Raw\MusicOnHold
     */
     ...
     *
     * @return IvozProvider\Mapper\Sql\MusicOnHold
     */
    public function getMapper()
    {
        if ($this->_mapper === null) {
            ...
            if (class_exists('\IvozProvider\Mapper\Sql\MusicOnHold')) {

                $this->setMapper(new \IvozProvider\Mapper\Sql\MusicOnHold);
     ...
     *
     * @return null | \IvozProvider\Model\Validator\MusicOnHold
     */
    public function getValidator()
    {
        if ($this->_validator === null) {

            if (class_exists('\IvozProvider\\Validator\MusicOnHold')) {

                $this->setValidator(new \IvozProvider\Validator\MusicOnHold);
            }
        }
