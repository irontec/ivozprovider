...
class IVRCommon extends ModelAbstract
{
    ...
    /**
     * Dependent relation ConditionalRoutes_ibfk_2
    ...
    /**
     * Dependent relation ConditionalRoutesConditions_ibfk_2
     * Type: One-to-Many relationship
     *
    ...
    public function __construct()
    {
        ...
        $this->setOnDeleteSetNullRelationships(array(
            'ConditionalRoutes_ibfk_2',
            'ConditionalRoutesConditions_ibfk_2',
            'DDIs_ibfk_4',
            'Extensions_ibfk_2'
        ));
    ...
    ***************************************************************************/
    ...
    /**
     * Sets dependent relations ConditionalRoutes_ibfk_2
     *
    ...
    /**
     * Gets dependent ConditionalRoutes_ibfk_2
     *
    ...
    /**
     * Sets dependent relations ConditionalRoutesConditions_ibfk_2
     *
    ...
    /**
     * Gets dependent ConditionalRoutesConditions_ibfk_2
     *
     * @param string or array $where
     * @param string or array $orderBy
     * @param boolean $avoidLoading skip data loading if it is not already
