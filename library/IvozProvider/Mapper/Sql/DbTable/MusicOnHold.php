...
/**
 * Table definition for MusicOnHold
 *
 * @package IvozProvider\Mapper\Sql\DbTable
 * @subpackage DbTable
 * @author Luis Felipe Garcia
...
class MusicOnHold extends TableAbstract
{
    /**
    ...
    protected $_rowClass = 'IvozProvider\\Model\\MusicOnHold';
    protected $_rowMapperClass = 'IvozProvider\\Mapper\\Sql\\MusicOnHold';
