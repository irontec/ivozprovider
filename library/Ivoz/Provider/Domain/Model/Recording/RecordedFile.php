...
class RecordedFile
{
     ...
     * @return static
     */
    protected function setFileSize(?int $fileSize = null): RecordedFile
    {
        if (!is_null($fileSize)) {
     ...
     * @return static
     */
    protected function setMimeType(?string $mimeType = null): RecordedFile
    {
        if (!is_null($mimeType)) {
     ...
     * @return static
     */
    protected function setBaseName(?string $baseName = null): RecordedFile
    {
        if (!is_null($baseName)) {
