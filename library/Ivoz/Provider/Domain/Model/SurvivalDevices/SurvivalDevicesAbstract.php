...
abstract class SurvivalDevicesAbstract
{
    ...
    protected function __construct(
        ...
        $this->setName($name);
        $this->setProxy($proxy);
        $this->setOutboundProxy($outboundProxy);
    ...
    public static function fromDto(
        ...
        $outboundProxy = $dto->getOutboundProxy();
        Assertion::notNull($outboundProxy, 'getOutboundProxy value is null, but non null value was expected.');
    ...
    protected function setOutboundProxy(string $outboundProxy): static
    {
