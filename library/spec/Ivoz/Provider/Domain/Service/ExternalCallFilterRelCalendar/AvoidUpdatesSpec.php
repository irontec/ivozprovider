...
namespace spec\Ivoz\Provider\Domain\Service\ExternalCallFilterRelCalendar;

use Ivoz\Provider\Domain\Model\ExternalCallFilterRelCalendar\ExternalCallFilterRelCalendarInterface;
use Ivoz\Provider\Domain\Service\ExternalCallFilterRelCalendar\AvoidUpdates;
...
class AvoidUpdatesSpec extends ObjectBehavior
{
    ...
    function its_does_nothing_on_new_entities(
        ExternalCallFilterRelCalendarInterface $entity
    ) {
        $entity
            ->getId()
            ->willReturn(null)
