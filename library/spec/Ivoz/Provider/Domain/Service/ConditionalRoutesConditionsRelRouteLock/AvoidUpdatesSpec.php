...
namespace spec\Ivoz\Provider\Domain\Service\ConditionalRoutesConditionsRelRouteLock;

use Ivoz\Provider\Domain\Model\ConditionalRoutesConditionsRelRouteLock\ConditionalRoutesConditionsRelRouteLockInterface;
use Ivoz\Provider\Domain\Service\ConditionalRoutesConditionsRelRouteLock\AvoidUpdates;
...
class AvoidUpdatesSpec extends ObjectBehavior
{
    ...
    function its_does_nothing_on_new_entities(
        ConditionalRoutesConditionsRelRouteLockInterface $entity
    ) {
        $entity
            ->getId()
            ->willReturn(null)
