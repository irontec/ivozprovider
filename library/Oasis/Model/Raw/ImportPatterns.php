...
class ImportPatterns extends ModelAbstract
{
    ...
    /**
     * Parent relation ImportPatterns_ibfk_1
     *
    ...
    /**
     * Parent relation ImportPatterns_ibfk_2
     *
    ...
    ***************************************************************************/
     ...
     * @param int $data
     * @return \Oasis\Model\Raw\ImportPatterns
     */
    ...
    public function setBrand(\Oasis\Model\Raw\Brands $data)
    {
        ...
        $this->_setLoaded('ImportPatternsIbfk2');
        return $this;
    }
     ...
     *
     * @return Oasis\Mapper\Sql\ImportPatterns
     */
    public function getMapper()
    {
        if ($this->_mapper === null) {
            ...
            if (class_exists('\Oasis\Mapper\Sql\ImportPatterns')) {

                $this->setMapper(new \Oasis\Mapper\Sql\ImportPatterns);
     ...
     *
     * @return null | \Oasis\Model\Validator\ImportPatterns
     */
    public function getValidator()
    {
        if ($this->_validator === null) {

            if (class_exists('\Oasis\\Validator\ImportPatterns')) {

                $this->setValidator(new \Oasis\Validator\ImportPatterns);
            }
        }
     ...
     *
     * @see \Mapper\Sql\ImportPatterns::delete
