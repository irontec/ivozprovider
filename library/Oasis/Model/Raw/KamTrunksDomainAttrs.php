...
class KamTrunksDomainAttrs extends ModelAbstract
{
    ...
    ***************************************************************************/
     ...
     * @param int $data
     * @return \Oasis\Model\Raw\KamTrunksDomainAttrs
     */
     ...
     *
     * @return Oasis\Mapper\Sql\KamTrunksDomainAttrs
     */
    public function getMapper()
    {
        if ($this->_mapper === null) {
            ...
            if (class_exists('\Oasis\Mapper\Sql\KamTrunksDomainAttrs')) {

                $this->setMapper(new \Oasis\Mapper\Sql\KamTrunksDomainAttrs);
     ...
     *
     * @return null | \Oasis\Model\Validator\KamTrunksDomainAttrs
     */
    public function getValidator()
    {
        if ($this->_validator === null) {

            if (class_exists('\Oasis\\Validator\KamTrunksDomainAttrs')) {

                $this->setValidator(new \Oasis\Validator\KamTrunksDomainAttrs);
            }
        }
     ...
     *
     * @see \Mapper\Sql\KamTrunksDomainAttrs::delete
