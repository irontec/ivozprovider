...
class KamTrunksUsrPreferences extends ModelAbstract
{
    ...
    ***************************************************************************/
     ...
     * @param int $data
     * @return \Oasis\Model\Raw\KamTrunksUsrPreferences
     */
     ...
     *
     * @return Oasis\Mapper\Sql\KamTrunksUsrPreferences
     */
    public function getMapper()
    {
        if ($this->_mapper === null) {
            ...
            if (class_exists('\Oasis\Mapper\Sql\KamTrunksUsrPreferences')) {

                $this->setMapper(new \Oasis\Mapper\Sql\KamTrunksUsrPreferences);
     ...
     *
     * @return null | \Oasis\Model\Validator\KamTrunksUsrPreferences
     */
    public function getValidator()
    {
        if ($this->_validator === null) {

            if (class_exists('\Oasis\\Validator\KamTrunksUsrPreferences')) {

                $this->setValidator(new \Oasis\Validator\KamTrunksUsrPreferences);
            }
        }
     ...
     *
     * @see \Mapper\Sql\KamTrunksUsrPreferences::delete
