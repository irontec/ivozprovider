...
class KamTrunksDialogVars extends ModelAbstract
{
    ...
    ***************************************************************************/
     ...
     * @param int $data
     * @return \Oasis\Model\Raw\KamTrunksDialogVars
     */
     ...
     *
     * @return Oasis\Mapper\Sql\KamTrunksDialogVars
     */
    public function getMapper()
    {
        if ($this->_mapper === null) {
            ...
            if (class_exists('\Oasis\Mapper\Sql\KamTrunksDialogVars')) {

                $this->setMapper(new \Oasis\Mapper\Sql\KamTrunksDialogVars);
     ...
     *
     * @return null | \Oasis\Model\Validator\KamTrunksDialogVars
     */
    public function getValidator()
    {
        if ($this->_validator === null) {

            if (class_exists('\Oasis\\Validator\KamTrunksDialogVars')) {

                $this->setValidator(new \Oasis\Validator\KamTrunksDialogVars);
            }
        }
     ...
     *
     * @see \Mapper\Sql\KamTrunksDialogVars::delete
