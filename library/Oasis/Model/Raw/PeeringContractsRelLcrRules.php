...
class PeeringContractsRelLcrRules extends ModelAbstract
{
    ...
    ***************************************************************************/
     ...
     * @return \Oasis\Model\Raw\PeeringContractsRelLcrRules
     */
    public function setLcrRule(\Oasis\Model\Raw\LcrRules $data)
    {
        $this->_LcrRule = $data;
     ...
     *
     * @return Oasis\Mapper\Sql\PeeringContractsRelLcrRules
     */
    public function getMapper()
    {
        if ($this->_mapper === null) {
            ...
            if (class_exists('\Oasis\Mapper\Sql\PeeringContractsRelLcrRules')) {

                $this->setMapper(new \Oasis\Mapper\Sql\PeeringContractsRelLcrRules);
     ...
     *
     * @return null | \Oasis\Model\Validator\PeeringContractsRelLcrRules
     */
    public function getValidator()
    {
        if ($this->_validator === null) {

            if (class_exists('\Oasis\\Validator\PeeringContractsRelLcrRules')) {

                $this->setValidator(new \Oasis\Validator\PeeringContractsRelLcrRules);
            }
        }
