...
class ExternalCallFilters extends ModelAbstract
{
     ...
     * Type: One-to-Many relationship
     *
     * @var \Oasis\Model\Raw\ExternalCallFilterRelSchedules[]
     */
    ...
    ***************************************************************************/
     ...
     * @return \Oasis\Model\Raw\ExternalCallFilters
     */
    public function setWelcomeLocution(\Oasis\Model\Raw\Locutions $data)
    {
     ...
     * @return \Oasis\Model\Raw\ExternalCallFilters
     */
    public function setHolidayLocution(\Oasis\Model\Raw\Locutions $data)
    {
     ...
     * @return \Oasis\Model\Raw\ExternalCallFilters
     */
    public function setOutOfScheduleLocution(\Oasis\Model\Raw\Locutions $data)
    {
     ...
     * @return \Oasis\Model\Raw\ExternalCallFilters
     */
    public function setHolidayExtension(\Oasis\Model\Raw\Extensions $data)
    {
     ...
     * @return \Oasis\Model\Raw\ExternalCallFilters
     */
    public function setOutOfScheduleExtension(\Oasis\Model\Raw\Extensions $data)
    {
     ...
     * @return \Oasis\Model\Raw\ExternalCallFilters
     */
    public function setHolidayVoiceMailUser(\Oasis\Model\Raw\Users $data)
    {
     ...
     * @return \Oasis\Model\Raw\ExternalCallFilters
     */
    public function setOutOfScheduleVoiceMailUser(\Oasis\Model\Raw\Users $data)
    {
     ...
     *
     * @param array $data An array of \Oasis\Model\Raw\ExternalCallFilterRelSchedules
     * @return \Oasis\Model\Raw\ExternalCallFilters
     */
     ...
     * Sets dependent relations ExternalCallFilterRelSchedules_ibfk_1
     *
     * @param \Oasis\Model\Raw\ExternalCallFilterRelSchedules $data
     * @return \Oasis\Model\Raw\ExternalCallFilters
     */
    public function addExternalCallFilterRelSchedules(\Oasis\Model\Raw\ExternalCallFilterRelSchedules $data)
    {
     ...
     * @param string or array $orderBy
     * @param boolean $avoidLoading skip data loading if it is not already
     * @return array The array of \Oasis\Model\Raw\ExternalCallFilterRelSchedules
     */
     ...
     *
     * @return Oasis\Mapper\Sql\ExternalCallFilters
     */
    public function getMapper()
    {
        if ($this->_mapper === null) {
            ...
            if (class_exists('\Oasis\Mapper\Sql\ExternalCallFilters')) {

                $this->setMapper(new \Oasis\Mapper\Sql\ExternalCallFilters);
     ...
     *
     * @return null | \Oasis\Model\Validator\ExternalCallFilters
     */
    public function getValidator()
    {
        if ($this->_validator === null) {

            if (class_exists('\Oasis\\Validator\ExternalCallFilters')) {

                $this->setValidator(new \Oasis\Validator\ExternalCallFilters);
            }
        }
