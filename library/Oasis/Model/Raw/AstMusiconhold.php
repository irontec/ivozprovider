...
class AstMusiconhold extends ModelAbstract
{
    ...
    ***************************************************************************/
     ...
     * @param string $data
     * @return \Oasis\Model\Raw\AstMusiconhold
     */
     ...
     *
     * @return Oasis\Mapper\Sql\AstMusiconhold
     */
    public function getMapper()
    {
        if ($this->_mapper === null) {
            ...
            if (class_exists('\Oasis\Mapper\Sql\AstMusiconhold')) {

                $this->setMapper(new \Oasis\Mapper\Sql\AstMusiconhold);
     ...
     *
     * @return null | \Oasis\Model\Validator\AstMusiconhold
     */
    public function getValidator()
    {
        if ($this->_validator === null) {

            if (class_exists('\Oasis\\Validator\AstMusiconhold')) {

                $this->setValidator(new \Oasis\Validator\AstMusiconhold);
            }
        }
