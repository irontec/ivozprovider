...
class KamTrunksAcc extends ModelAbstract
{
    ...
    ***************************************************************************/
     ...
     * @param int $data
     * @return \Oasis\Model\Raw\KamTrunksAcc
     */
     ...
     *
     * @return Oasis\Mapper\Sql\KamTrunksAcc
     */
    public function getMapper()
    {
        if ($this->_mapper === null) {
            ...
            if (class_exists('\Oasis\Mapper\Sql\KamTrunksAcc')) {

                $this->setMapper(new \Oasis\Mapper\Sql\KamTrunksAcc);
     ...
     *
     * @return null | \Oasis\Model\Validator\KamTrunksAcc
     */
    public function getValidator()
    {
        if ($this->_validator === null) {

            if (class_exists('\Oasis\\Validator\KamTrunksAcc')) {

                $this->setValidator(new \Oasis\Validator\KamTrunksAcc);
            }
        }
     ...
     *
     * @see \Mapper\Sql\KamTrunksAcc::delete
