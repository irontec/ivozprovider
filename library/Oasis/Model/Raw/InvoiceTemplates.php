...
class InvoiceTemplates extends ModelAbstract
{
    ...
    ***************************************************************************/
     ...
     * @param binary $data
     * @return \Oasis\Model\Raw\InvoiceTemplates
     */
     ...
     *
     * @return Oasis\Mapper\Sql\InvoiceTemplates
     */
    public function getMapper()
    {
        if ($this->_mapper === null) {
            ...
            if (class_exists('\Oasis\Mapper\Sql\InvoiceTemplates')) {

                $this->setMapper(new \Oasis\Mapper\Sql\InvoiceTemplates);
     ...
     *
     * @return null | \Oasis\Model\Validator\InvoiceTemplates
     */
    public function getValidator()
    {
        if ($this->_validator === null) {

            if (class_exists('\Oasis\\Validator\InvoiceTemplates')) {

                $this->setValidator(new \Oasis\Validator\InvoiceTemplates);
            }
        }
