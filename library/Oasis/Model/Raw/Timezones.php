...
class Timezones extends ModelAbstract
{
     ...
     * Type: One-to-Many relationship
     *
     * @var \Oasis\Model\Raw\MainOperators[]
     */
    ...
    ***************************************************************************/
     ...
     *
     * @param array $data An array of \Oasis\Model\Raw\Brands
     * @return \Oasis\Model\Raw\Timezones
     */
     ...
     * @return \Oasis\Model\Raw\Timezones
     */
    public function addBrands(\Oasis\Model\Raw\Brands $data)
    {
        $this->_Brands[] = $data;
     ...
     * @param string or array $orderBy
     * @param boolean $avoidLoading skip data loading if it is not already
     * @return array The array of \Oasis\Model\Raw\Brands
     */
     ...
     *
     * @param array $data An array of \Oasis\Model\Raw\MainOperators
     * @return \Oasis\Model\Raw\Timezones
     */
     ...
     * Sets dependent relations MainOperators_ibfk_1
     *
     * @param \Oasis\Model\Raw\MainOperators $data
     * @return \Oasis\Model\Raw\Timezones
     */
    public function addMainOperators(\Oasis\Model\Raw\MainOperators $data)
    {
     ...
     * @param string or array $orderBy
     * @param boolean $avoidLoading skip data loading if it is not already
     * @return array The array of \Oasis\Model\Raw\MainOperators
     */
     ...
     *
     * @return Oasis\Mapper\Sql\Timezones
     */
    public function getMapper()
    {
        if ($this->_mapper === null) {
            ...
            if (class_exists('\Oasis\Mapper\Sql\Timezones')) {

                $this->setMapper(new \Oasis\Mapper\Sql\Timezones);
     ...
     *
     * @return null | \Oasis\Model\Validator\Timezones
     */
    public function getValidator()
    {
        if ($this->_validator === null) {

            if (class_exists('\Oasis\\Validator\Timezones')) {

                $this->setValidator(new \Oasis\Validator\Timezones);
            }
        }
