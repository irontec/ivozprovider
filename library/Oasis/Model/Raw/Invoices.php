...
class Invoices extends ModelAbstract
{
    ...
    ***************************************************************************/
     ...
     * @param int $data
     * @return \Oasis\Model\Raw\Invoices
     */
     ...
     * @return \Oasis\Model\Raw\Invoices
     */
    public function setInvoiceTemplate(\Oasis\Model\Raw\InvoiceTemplates $data)
    {
     ...
     *
     * @return Oasis\Mapper\Sql\Invoices
     */
    public function getMapper()
    {
        if ($this->_mapper === null) {
            ...
            if (class_exists('\Oasis\Mapper\Sql\Invoices')) {

                $this->setMapper(new \Oasis\Mapper\Sql\Invoices);
     ...
     *
     * @return null | \Oasis\Model\Validator\Invoices
     */
    public function getValidator()
    {
        if ($this->_validator === null) {

            if (class_exists('\Oasis\\Validator\Invoices')) {

                $this->setValidator(new \Oasis\Validator\Invoices);
            }
        }
