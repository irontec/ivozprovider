...
class KamTrunksMissedCalls extends ModelAbstract
{
    ...
    ***************************************************************************/
     ...
     * @param int $data
     * @return \Oasis\Model\Raw\KamTrunksMissedCalls
     */
     ...
     *
     * @return Oasis\Mapper\Sql\KamTrunksMissedCalls
     */
    public function getMapper()
    {
        if ($this->_mapper === null) {
            ...
            if (class_exists('\Oasis\Mapper\Sql\KamTrunksMissedCalls')) {

                $this->setMapper(new \Oasis\Mapper\Sql\KamTrunksMissedCalls);
     ...
     *
     * @return null | \Oasis\Model\Validator\KamTrunksMissedCalls
     */
    public function getValidator()
    {
        if ($this->_validator === null) {

            if (class_exists('\Oasis\\Validator\KamTrunksMissedCalls')) {

                $this->setValidator(new \Oasis\Validator\KamTrunksMissedCalls);
            }
        }
     ...
     *
     * @see \Mapper\Sql\KamTrunksMissedCalls::delete
