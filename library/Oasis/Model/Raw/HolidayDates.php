...
class HolidayDates extends ModelAbstract
{
    ...
    ***************************************************************************/
     ...
     * @return \Oasis\Model\Raw\HolidayDates
     */
    public function setLocution(\Oasis\Model\Raw\Locutions $data)
    {
        $this->_Locution = $data;
     ...
     *
     * @return Oasis\Mapper\Sql\HolidayDates
     */
    public function getMapper()
    {
        if ($this->_mapper === null) {
            ...
            if (class_exists('\Oasis\Mapper\Sql\HolidayDates')) {

                $this->setMapper(new \Oasis\Mapper\Sql\HolidayDates);
     ...
     *
     * @return null | \Oasis\Model\Validator\HolidayDates
     */
    public function getValidator()
    {
        if ($this->_validator === null) {

            if (class_exists('\Oasis\\Validator\HolidayDates')) {

                $this->setValidator(new \Oasis\Validator\HolidayDates);
            }
        }
