...
class KamTrunksAddress extends ModelAbstract
{
    ...
    /**
     * Parent relation kam_trunks_address_ibfk_1
     *
    ...
    ***************************************************************************/
     ...
     * @param int $data
     * @return \Oasis\Model\Raw\KamTrunksAddress
     */
    ...
    public function setPeerServer(\Oasis\Model\Raw\PeerServers $data)
    {
        ...
        $this->_setLoaded('KamTrunksAddressIbfk1');
        return $this;
    }
     ...
     *
     * @return Oasis\Mapper\Sql\KamTrunksAddress
     */
    public function getMapper()
    {
        if ($this->_mapper === null) {
            ...
            if (class_exists('\Oasis\Mapper\Sql\KamTrunksAddress')) {

                $this->setMapper(new \Oasis\Mapper\Sql\KamTrunksAddress);
     ...
     *
     * @return null | \Oasis\Model\Validator\KamTrunksAddress
     */
    public function getValidator()
    {
        if ($this->_validator === null) {

            if (class_exists('\Oasis\\Validator\KamTrunksAddress')) {

                $this->setValidator(new \Oasis\Validator\KamTrunksAddress);
            }
        }
