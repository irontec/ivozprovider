...
class KamUsersTrusted extends ModelAbstract
{
    ...
    ***************************************************************************/
     ...
     * @param int $data
     * @return \Oasis\Model\Raw\KamUsersTrusted
     */
     ...
     *
     * @return Oasis\Mapper\Sql\KamUsersTrusted
     */
    public function getMapper()
    {
        if ($this->_mapper === null) {
            ...
            if (class_exists('\Oasis\Mapper\Sql\KamUsersTrusted')) {

                $this->setMapper(new \Oasis\Mapper\Sql\KamUsersTrusted);
     ...
     *
     * @return null | \Oasis\Model\Validator\KamUsersTrusted
     */
    public function getValidator()
    {
        if ($this->_validator === null) {

            if (class_exists('\Oasis\\Validator\KamUsersTrusted')) {

                $this->setValidator(new \Oasis\Validator\KamUsersTrusted);
            }
        }
     ...
     *
     * @see \Mapper\Sql\KamUsersTrusted::delete
