...
class LcrRules extends ModelAbstract
{
    ...
    ***************************************************************************/
     ...
     *
     * @return Oasis\Mapper\Sql\LcrRules
     */
    public function getMapper()
    {
        if ($this->_mapper === null) {
            ...
            if (class_exists('\Oasis\Mapper\Sql\LcrRules')) {

                $this->setMapper(new \Oasis\Mapper\Sql\LcrRules);
     ...
     *
     * @return null | \Oasis\Model\Validator\LcrRules
     */
    public function getValidator()
    {
        if ($this->_validator === null) {

            if (class_exists('\Oasis\\Validator\LcrRules')) {

                $this->setValidator(new \Oasis\Validator\LcrRules);
            }
        }
