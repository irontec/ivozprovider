...
class AstVoicemail extends ModelAbstract
{
    ...
    ***************************************************************************/
     ...
     * @param int $data
     * @return \Oasis\Model\Raw\AstVoicemail
     */
     ...
     *
     * @return Oasis\Mapper\Sql\AstVoicemail
     */
    public function getMapper()
    {
        if ($this->_mapper === null) {
            ...
            if (class_exists('\Oasis\Mapper\Sql\AstVoicemail')) {

                $this->setMapper(new \Oasis\Mapper\Sql\AstVoicemail);
     ...
     *
     * @return null | \Oasis\Model\Validator\AstVoicemail
     */
    public function getValidator()
    {
        if ($this->_validator === null) {

            if (class_exists('\Oasis\\Validator\AstVoicemail')) {

                $this->setValidator(new \Oasis\Validator\AstVoicemail);
            }
        }
