...
class KamTrunksAccCdrs extends ModelAbstract
{
    ...
    ***************************************************************************/
     ...
     * @param int $data
     * @return \Oasis\Model\Raw\KamTrunksAccCdrs
     */
     ...
     *
     * @return Oasis\Mapper\Sql\KamTrunksAccCdrs
     */
    public function getMapper()
    {
        if ($this->_mapper === null) {
            ...
            if (class_exists('\Oasis\Mapper\Sql\KamTrunksAccCdrs')) {

                $this->setMapper(new \Oasis\Mapper\Sql\KamTrunksAccCdrs);
     ...
     *
     * @return null | \Oasis\Model\Validator\KamTrunksAccCdrs
     */
    public function getValidator()
    {
        if ($this->_validator === null) {

            if (class_exists('\Oasis\\Validator\KamTrunksAccCdrs')) {

                $this->setValidator(new \Oasis\Validator\KamTrunksAccCdrs);
            }
        }
     ...
     *
     * @see \Mapper\Sql\KamTrunksAccCdrs::delete
