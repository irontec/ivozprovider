...
class IVRCustomEntries extends ModelAbstract
{
    ...
    ***************************************************************************/
     ...
     * @param binary $data
     * @return \Oasis\Model\Raw\IVRCustomEntries
     */
     ...
     * @return \Oasis\Model\Raw\IVRCustomEntries
     */
    public function setTargetExtension(\Oasis\Model\Raw\Extensions $data)
    {
     ...
     * @return \Oasis\Model\Raw\IVRCustomEntries
     */
    public function setTargetVoiceMailUser(\Oasis\Model\Raw\Users $data)
    {
     ...
     *
     * @return Oasis\Mapper\Sql\IVRCustomEntries
     */
    public function getMapper()
    {
        if ($this->_mapper === null) {
            ...
            if (class_exists('\Oasis\Mapper\Sql\IVRCustomEntries')) {

                $this->setMapper(new \Oasis\Mapper\Sql\IVRCustomEntries);
     ...
     *
     * @return null | \Oasis\Model\Validator\IVRCustomEntries
     */
    public function getValidator()
    {
        if ($this->_validator === null) {

            if (class_exists('\Oasis\\Validator\IVRCustomEntries')) {

                $this->setValidator(new \Oasis\Validator\IVRCustomEntries);
            }
        }
