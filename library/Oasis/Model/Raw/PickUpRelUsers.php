...
class PickUpRelUsers extends ModelAbstract
{
    ...
    ***************************************************************************/
     ...
     * @param binary $data
     * @return \Oasis\Model\Raw\PickUpRelUsers
     */
     ...
     * @return \Oasis\Model\Raw\PickUpRelUsers
     */
    public function setPickUpGroup(\Oasis\Model\Raw\PickUpGroups $data)
    {
     ...
     * @return \Oasis\Model\Raw\PickUpGroups
     */
     ...
     *
     * @return Oasis\Mapper\Sql\PickUpRelUsers
     */
    public function getMapper()
    {
        if ($this->_mapper === null) {
            ...
            if (class_exists('\Oasis\Mapper\Sql\PickUpRelUsers')) {

                $this->setMapper(new \Oasis\Mapper\Sql\PickUpRelUsers);
     ...
     *
     * @return null | \Oasis\Model\Validator\PickUpRelUsers
     */
    public function getValidator()
    {
        if ($this->_validator === null) {

            if (class_exists('\Oasis\\Validator\PickUpRelUsers')) {

                $this->setValidator(new \Oasis\Validator\PickUpRelUsers);
            }
        }
