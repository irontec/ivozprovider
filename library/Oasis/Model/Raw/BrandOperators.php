...
class BrandOperators extends ModelAbstract
{
    ...
    ***************************************************************************/
     ...
     * @param binary $data
     * @return \Oasis\Model\Raw\BrandOperators
     */
     ...
     *
     * @return Oasis\Mapper\Sql\BrandOperators
     */
    public function getMapper()
    {
        if ($this->_mapper === null) {
            ...
            if (class_exists('\Oasis\Mapper\Sql\BrandOperators')) {

                $this->setMapper(new \Oasis\Mapper\Sql\BrandOperators);
     ...
     *
     * @return null | \Oasis\Model\Validator\BrandOperators
     */
    public function getValidator()
    {
        if ($this->_validator === null) {

            if (class_exists('\Oasis\\Validator\BrandOperators')) {

                $this->setValidator(new \Oasis\Validator\BrandOperators);
            }
        }
