...
class KamAddress extends ModelAbstract
{
    ...
    /**
     * Parent relation kam_address_ibfk_1
     *
    ...
    ***************************************************************************/
     ...
     * @param int $data
     * @return \Oasis\Model\Raw\KamAddress
     */
     ...
     *
     * @return Oasis\Mapper\Sql\KamAddress
     */
    public function getMapper()
    {
        if ($this->_mapper === null) {
            ...
            if (class_exists('\Oasis\Mapper\Sql\KamAddress')) {

                $this->setMapper(new \Oasis\Mapper\Sql\KamAddress);
     ...
     *
     * @return null | \Oasis\Model\Validator\KamAddress
     */
    public function getValidator()
    {
        if ($this->_validator === null) {

            if (class_exists('\Oasis\\Validator\KamAddress')) {

                $this->setValidator(new \Oasis\Validator\KamAddress);
            }
        }
     ...
     *
     * @see \Mapper\Sql\KamAddress::delete
