...
class PickUpGroups extends ModelAbstract
{
    ...
    ***************************************************************************/
     ...
     *
     * @return Oasis\Mapper\Sql\PickUpGroups
     */
    public function getMapper()
    {
        if ($this->_mapper === null) {
            ...
            if (class_exists('\Oasis\Mapper\Sql\PickUpGroups')) {

                $this->setMapper(new \Oasis\Mapper\Sql\PickUpGroups);
     ...
     *
     * @return null | \Oasis\Model\Validator\PickUpGroups
     */
    public function getValidator()
    {
        if ($this->_validator === null) {

            if (class_exists('\Oasis\\Validator\PickUpGroups')) {

                $this->setValidator(new \Oasis\Validator\PickUpGroups);
            }
        }
