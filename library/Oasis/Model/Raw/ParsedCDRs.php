...
class ParsedCDRs extends ModelAbstract
{
    ...
    ***************************************************************************/
     ...
     * @param int $data
     * @return \Oasis\Model\Raw\ParsedCDRs
     */
     ...
     * @return \Oasis\Model\Raw\ParsedCDRs
     */
    public function setInvoice(\Oasis\Model\Raw\Invoices $data)
    {
        $this->_Invoice = $data;
     ...
     *
     * @return Oasis\Mapper\Sql\ParsedCDRs
     */
    public function getMapper()
    {
        if ($this->_mapper === null) {
            ...
            if (class_exists('\Oasis\Mapper\Sql\ParsedCDRs')) {

                $this->setMapper(new \Oasis\Mapper\Sql\ParsedCDRs);
     ...
     *
     * @return null | \Oasis\Model\Validator\ParsedCDRs
     */
    public function getValidator()
    {
        if ($this->_validator === null) {

            if (class_exists('\Oasis\\Validator\ParsedCDRs')) {

                $this->setValidator(new \Oasis\Validator\ParsedCDRs);
            }
        }
