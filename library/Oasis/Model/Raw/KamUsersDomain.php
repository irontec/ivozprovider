...
class KamUsersDomain extends ModelAbstract
{
    ...
    ***************************************************************************/
     ...
     * @param int $data
     * @return \Oasis\Model\Raw\KamUsersDomain
     */
     ...
     *
     * @return Oasis\Mapper\Sql\KamUsersDomain
     */
    public function getMapper()
    {
        if ($this->_mapper === null) {
            ...
            if (class_exists('\Oasis\Mapper\Sql\KamUsersDomain')) {

                $this->setMapper(new \Oasis\Mapper\Sql\KamUsersDomain);
     ...
     *
     * @return null | \Oasis\Model\Validator\KamUsersDomain
     */
    public function getValidator()
    {
        if ($this->_validator === null) {

            if (class_exists('\Oasis\\Validator\KamUsersDomain')) {

                $this->setValidator(new \Oasis\Validator\KamUsersDomain);
            }
        }
