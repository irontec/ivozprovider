...
class CallForwardSettings extends ModelAbstract
{
    ...
    ***************************************************************************/
     ...
     * @param binary $data
     * @return \Oasis\Model\Raw\CallForwardSettings
     */
     ...
     * @return \Oasis\Model\Raw\CallForwardSettings
     */
    public function setVoiceMailUser(\Oasis\Model\Raw\Users $data)
    {
     ...
     *
     * @return Oasis\Mapper\Sql\CallForwardSettings
     */
    public function getMapper()
    {
        if ($this->_mapper === null) {
            ...
            if (class_exists('\Oasis\Mapper\Sql\CallForwardSettings')) {

                $this->setMapper(new \Oasis\Mapper\Sql\CallForwardSettings);
     ...
     *
     * @return null | \Oasis\Model\Validator\CallForwardSettings
     */
    public function getValidator()
    {
        if ($this->_validator === null) {

            if (class_exists('\Oasis\\Validator\CallForwardSettings')) {

                $this->setValidator(new \Oasis\Validator\CallForwardSettings);
            }
        }
