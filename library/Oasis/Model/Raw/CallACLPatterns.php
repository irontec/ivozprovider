...
class CallACLPatterns extends ModelAbstract
{
    ...
    ***************************************************************************/
     ...
     *
     * @return Oasis\Mapper\Sql\CallACLPatterns
     */
    public function getMapper()
    {
        if ($this->_mapper === null) {
            ...
            if (class_exists('\Oasis\Mapper\Sql\CallACLPatterns')) {

                $this->setMapper(new \Oasis\Mapper\Sql\CallACLPatterns);
     ...
     *
     * @return null | \Oasis\Model\Validator\CallACLPatterns
     */
    public function getValidator()
    {
        if ($this->_validator === null) {

            if (class_exists('\Oasis\\Validator\CallACLPatterns')) {

                $this->setValidator(new \Oasis\Validator\CallACLPatterns);
            }
        }
