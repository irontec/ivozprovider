...
class KamUsersDialplan extends ModelAbstract
{
    ...
    ***************************************************************************/
     ...
     * @param int $data
     * @return \Oasis\Model\Raw\KamUsersDialplan
     */
     ...
     * @return \Oasis\Model\Raw\KamUsersDialplan
     */
    public function setTransformationRulesetGroupsUsers(\Oasis\Model\Raw\TransformationRulesetGroupsUsers $data)
    {
     ...
     *
     * @return Oasis\Mapper\Sql\KamUsersDialplan
     */
    public function getMapper()
    {
        if ($this->_mapper === null) {
            ...
            if (class_exists('\Oasis\Mapper\Sql\KamUsersDialplan')) {

                $this->setMapper(new \Oasis\Mapper\Sql\KamUsersDialplan);
     ...
     *
     * @return null | \Oasis\Model\Validator\KamUsersDialplan
     */
    public function getValidator()
    {
        if ($this->_validator === null) {

            if (class_exists('\Oasis\\Validator\KamUsersDialplan')) {

                $this->setValidator(new \Oasis\Validator\KamUsersDialplan);
            }
        }
