...
class KamDispatcher extends ModelAbstract
{
    ...
    ***************************************************************************/
     ...
     * @param binary $data
     * @return \Oasis\Model\Raw\KamDispatcher
     */
     ...
     *
     * @return Oasis\Mapper\Sql\KamDispatcher
     */
    public function getMapper()
    {
        if ($this->_mapper === null) {
            ...
            if (class_exists('\Oasis\Mapper\Sql\KamDispatcher')) {

                $this->setMapper(new \Oasis\Mapper\Sql\KamDispatcher);
     ...
     *
     * @return null | \Oasis\Model\Validator\KamDispatcher
     */
    public function getValidator()
    {
        if ($this->_validator === null) {

            if (class_exists('\Oasis\\Validator\KamDispatcher')) {

                $this->setValidator(new \Oasis\Validator\KamDispatcher);
            }
        }
