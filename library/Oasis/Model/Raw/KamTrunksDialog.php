...
class KamTrunksDialog extends ModelAbstract
{
    ...
    ***************************************************************************/
     ...
     * @param int $data
     * @return \Oasis\Model\Raw\KamTrunksDialog
     */
     ...
     *
     * @return Oasis\Mapper\Sql\KamTrunksDialog
     */
    public function getMapper()
    {
        if ($this->_mapper === null) {
            ...
            if (class_exists('\Oasis\Mapper\Sql\KamTrunksDialog')) {

                $this->setMapper(new \Oasis\Mapper\Sql\KamTrunksDialog);
     ...
     *
     * @return null | \Oasis\Model\Validator\KamTrunksDialog
     */
    public function getValidator()
    {
        if ($this->_validator === null) {

            if (class_exists('\Oasis\\Validator\KamTrunksDialog')) {

                $this->setValidator(new \Oasis\Validator\KamTrunksDialog);
            }
        }
     ...
     *
     * @see \Mapper\Sql\KamTrunksDialog::delete
