...
class XMLRPCLogs extends ModelAbstract
{
    ...
    ***************************************************************************/
     ...
     * @param int $data
     * @return \Oasis\Model\Raw\XMLRPCLogs
     */
     ...
     *
     * @return Oasis\Mapper\Sql\XMLRPCLogs
     */
    public function getMapper()
    {
        if ($this->_mapper === null) {
            ...
            if (class_exists('\Oasis\Mapper\Sql\XMLRPCLogs')) {

                $this->setMapper(new \Oasis\Mapper\Sql\XMLRPCLogs);
     ...
     *
     * @return null | \Oasis\Model\Validator\XMLRPCLogs
     */
    public function getValidator()
    {
        if ($this->_validator === null) {

            if (class_exists('\Oasis\\Validator\XMLRPCLogs')) {

                $this->setValidator(new \Oasis\Validator\XMLRPCLogs);
            }
        }
