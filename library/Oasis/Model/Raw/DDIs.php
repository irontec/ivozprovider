...
class DDIs extends ModelAbstract
{
    ...
    ***************************************************************************/
     ...
     * @return \Oasis\Model\Raw\DDIs
     */
    public function setFax(\Oasis\Model\Raw\Faxes $data)
    {
        $this->_Fax = $data;
     ...
     * @return \Oasis\Model\Raw\DDIs
     */
    public function setExternalCallFilter(\Oasis\Model\Raw\ExternalCallFilters $data)
    {
    ...
    public function getMapper()
    {
        if ($this->_mapper === null) {
            ...
            if (class_exists('\Oasis\Mapper\Sql\DDIs')) {

                $this->setMapper(new \Oasis\Mapper\Sql\DDIs);
     ...
     *
     * @return null | \Oasis\Model\Validator\DDIs
     */
    public function getValidator()
    {
        if ($this->_validator === null) {

            if (class_exists('\Oasis\\Validator\DDIs')) {

                $this->setValidator(new \Oasis\Validator\DDIs);
            }
        }
