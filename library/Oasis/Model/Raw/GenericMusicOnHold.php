...
class GenericMusicOnHold extends ModelAbstract
{
    ...
    ***************************************************************************/
     ...
     * @param binary $data
     * @return \Oasis\Model\Raw\GenericMusicOnHold
     */
     ...
     *
     * @return Oasis\Mapper\Sql\GenericMusicOnHold
     */
    public function getMapper()
    {
        if ($this->_mapper === null) {
            ...
            if (class_exists('\Oasis\Mapper\Sql\GenericMusicOnHold')) {

                $this->setMapper(new \Oasis\Mapper\Sql\GenericMusicOnHold);
     ...
     *
     * @return null | \Oasis\Model\Validator\GenericMusicOnHold
     */
    public function getValidator()
    {
        if ($this->_validator === null) {

            if (class_exists('\Oasis\\Validator\GenericMusicOnHold')) {

                $this->setValidator(new \Oasis\Validator\GenericMusicOnHold);
            }
        }
