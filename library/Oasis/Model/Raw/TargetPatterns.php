...
class TargetPatterns extends ModelAbstract
{
    ...
    ***************************************************************************/
     ...
     *
     * @return Oasis\Mapper\Sql\TargetPatterns
     */
    public function getMapper()
    {
        if ($this->_mapper === null) {
            ...
            if (class_exists('\Oasis\Mapper\Sql\TargetPatterns')) {

                $this->setMapper(new \Oasis\Mapper\Sql\TargetPatterns);
     ...
     *
     * @return null | \Oasis\Model\Validator\TargetPatterns
     */
    public function getValidator()
    {
        if ($this->_validator === null) {

            if (class_exists('\Oasis\\Validator\TargetPatterns')) {

                $this->setValidator(new \Oasis\Validator\TargetPatterns);
            }
        }
