...
class Brands extends ModelAbstract
{
     ...
     *
     * @var \Oasis\Model\Raw\BrandOperators[]
     */
     ...
     * Type: One-to-Many relationship
     *
     * @var \Oasis\Model\Raw\GenericCallACLPatterns[]
     */
     ...
     * Type: One-to-Many relationship
     *
     * @var \Oasis\Model\Raw\GenericMusicOnHold[]
     */
     ...
     * Type: One-to-Many relationship
     *
     * @var \Oasis\Model\Raw\GenericServices[]
     */
     ...
     * Type: One-to-Many relationship
     *
     * @var \Oasis\Model\Raw\InvoiceTemplates[]
     */
     ...
     * Type: One-to-Many relationship
     *
     * @var \Oasis\Model\Raw\LcrRuleTarget[]
     */
     ...
     * Type: One-to-Many relationship
     *
     * @var \Oasis\Model\Raw\PricingPlansRelTargetPatterns[]
     */
     ...
     * Type: One-to-Many relationship
     *
     * @var \Oasis\Model\Raw\KamTrunksUacreg[]
     */
    ...
    ***************************************************************************/
     ...
     *
     * @param array $data An array of \Oasis\Model\Raw\BrandOperators
     * @return \Oasis\Model\Raw\Brands
     */
     ...
     * Sets dependent relations BrandOperators_ibfk_3
     *
     * @param \Oasis\Model\Raw\BrandOperators $data
     * @return \Oasis\Model\Raw\Brands
     */
    public function addBrandOperators(\Oasis\Model\Raw\BrandOperators $data)
    {
     ...
     * @return array The array of \Oasis\Model\Raw\BrandOperators
     */
     ...
     *
     * @param array $data An array of \Oasis\Model\Raw\BrandURLs
     * @return \Oasis\Model\Raw\Brands
     */
     ...
     * Sets dependent relations BrandURLs_ibfk_1
     *
     * @param \Oasis\Model\Raw\BrandURLs $data
     * @return \Oasis\Model\Raw\Brands
     */
    public function addBrandURLs(\Oasis\Model\Raw\BrandURLs $data)
    {
     ...
     * @param string or array $orderBy
     * @param boolean $avoidLoading skip data loading if it is not already
     * @return array The array of \Oasis\Model\Raw\BrandURLs
     */
     ...
     *
     * @param array $data An array of \Oasis\Model\Raw\GenericCallACLPatterns
     * @return \Oasis\Model\Raw\Brands
     */
     ...
     * Sets dependent relations GenericCallACLPatterns_ibfk_1
     *
     * @param \Oasis\Model\Raw\GenericCallACLPatterns $data
     * @return \Oasis\Model\Raw\Brands
     */
    public function addGenericCallACLPatterns(\Oasis\Model\Raw\GenericCallACLPatterns $data)
    {
     ...
     * @param string or array $orderBy
     * @param boolean $avoidLoading skip data loading if it is not already
     * @return array The array of \Oasis\Model\Raw\GenericCallACLPatterns
     */
     ...
     *
     * @param array $data An array of \Oasis\Model\Raw\GenericMusicOnHold
     * @return \Oasis\Model\Raw\Brands
     */
     ...
     * Sets dependent relations fGenericMusicOnHold_ibfk_1
     *
     * @param \Oasis\Model\Raw\GenericMusicOnHold $data
     * @return \Oasis\Model\Raw\Brands
     */
    public function addGenericMusicOnHold(\Oasis\Model\Raw\GenericMusicOnHold $data)
    {
     ...
     * @param string or array $orderBy
     * @param boolean $avoidLoading skip data loading if it is not already
     * @return array The array of \Oasis\Model\Raw\GenericMusicOnHold
     */
     ...
     *
     * @param array $data An array of \Oasis\Model\Raw\GenericServices
     * @return \Oasis\Model\Raw\Brands
     */
     ...
     * Sets dependent relations GenericServices_ibfk_1
     *
     * @param \Oasis\Model\Raw\GenericServices $data
     * @return \Oasis\Model\Raw\Brands
     */
    public function addGenericServices(\Oasis\Model\Raw\GenericServices $data)
    {
     ...
     * @param string or array $orderBy
     * @param boolean $avoidLoading skip data loading if it is not already
     * @return array The array of \Oasis\Model\Raw\GenericServices
     */
     ...
     *
     * @param array $data An array of \Oasis\Model\Raw\InvoiceTemplates
     * @return \Oasis\Model\Raw\Brands
     */
     ...
     * Sets dependent relations InvoiceTemplates_ibfk_1
     *
     * @param \Oasis\Model\Raw\InvoiceTemplates $data
     * @return \Oasis\Model\Raw\Brands
     */
    public function addInvoiceTemplates(\Oasis\Model\Raw\InvoiceTemplates $data)
    {
     ...
     * @param string or array $orderBy
     * @param boolean $avoidLoading skip data loading if it is not already
     * @return array The array of \Oasis\Model\Raw\InvoiceTemplates
     */
     ...
     *
     * @param array $data An array of \Oasis\Model\Raw\LcrRuleTarget
     * @return \Oasis\Model\Raw\Brands
     */
     ...
     * Sets dependent relations LcrRuleTarget_ibfk_3
     *
     * @param \Oasis\Model\Raw\LcrRuleTarget $data
     * @return \Oasis\Model\Raw\Brands
     */
    public function addLcrRuleTarget(\Oasis\Model\Raw\LcrRuleTarget $data)
    {
     ...
     * @param string or array $orderBy
     * @param boolean $avoidLoading skip data loading if it is not already
     * @return array The array of \Oasis\Model\Raw\LcrRuleTarget
     */
     ...
     *
     * @param array $data An array of \Oasis\Model\Raw\LcrRules
     * @return \Oasis\Model\Raw\Brands
     */
     ...
     * @return \Oasis\Model\Raw\Brands
     */
    public function addLcrRules(\Oasis\Model\Raw\LcrRules $data)
    {
        $this->_LcrRules[] = $data;
     ...
     * @param string or array $orderBy
     * @param boolean $avoidLoading skip data loading if it is not already
     * @return array The array of \Oasis\Model\Raw\LcrRules
     */
     ...
     *
     * @param array $data An array of \Oasis\Model\Raw\PeerServers
     * @return \Oasis\Model\Raw\Brands
     */
     ...
     * @return \Oasis\Model\Raw\Brands
     */
    public function addPeerServers(\Oasis\Model\Raw\PeerServers $data)
    {
     ...
     * @param string or array $orderBy
     * @param boolean $avoidLoading skip data loading if it is not already
     * @return array The array of \Oasis\Model\Raw\PeerServers
     */
     ...
     *
     * @param array $data An array of \Oasis\Model\Raw\PeeringContracts
     * @return \Oasis\Model\Raw\Brands
     */
     ...
     * @return \Oasis\Model\Raw\Brands
     */
    public function addPeeringContracts(\Oasis\Model\Raw\PeeringContracts $data)
    {
     ...
     * @param string or array $orderBy
     * @param boolean $avoidLoading skip data loading if it is not already
     * @return array The array of \Oasis\Model\Raw\PeeringContracts
     */
     ...
     *
     * @param array $data An array of \Oasis\Model\Raw\PeeringContractsRelLcrRules
     * @return \Oasis\Model\Raw\Brands
     */
     ...
     * @return \Oasis\Model\Raw\Brands
     */
    public function addPeeringContractsRelLcrRules(\Oasis\Model\Raw\PeeringContractsRelLcrRules $data)
    {
     ...
     * @param string or array $orderBy
     * @param boolean $avoidLoading skip data loading if it is not already
     * @return array The array of \Oasis\Model\Raw\PeeringContractsRelLcrRules
     */
     ...
     *
     * @param array $data An array of \Oasis\Model\Raw\PricingPlans
     * @return \Oasis\Model\Raw\Brands
     */
     ...
     * @return \Oasis\Model\Raw\Brands
     */
    public function addPricingPlans(\Oasis\Model\Raw\PricingPlans $data)
    {
     ...
     * @param string or array $orderBy
     * @param boolean $avoidLoading skip data loading if it is not already
     * @return array The array of \Oasis\Model\Raw\PricingPlans
     */
     ...
     *
     * @param array $data An array of \Oasis\Model\Raw\PricingPlansRelTargetPatterns
     * @return \Oasis\Model\Raw\Brands
     */
     ...
     * Sets dependent relations PricingPlansRelTargetPatterns_ibfk_3
     *
     * @param \Oasis\Model\Raw\PricingPlansRelTargetPatterns $data
     * @return \Oasis\Model\Raw\Brands
     */
    public function addPricingPlansRelTargetPatterns(\Oasis\Model\Raw\PricingPlansRelTargetPatterns $data)
    {
     ...
     * @param string or array $orderBy
     * @param boolean $avoidLoading skip data loading if it is not already
     * @return array The array of \Oasis\Model\Raw\PricingPlansRelTargetPatterns
     */
     ...
     *
     * @param array $data An array of \Oasis\Model\Raw\TargetPatterns
     * @return \Oasis\Model\Raw\Brands
     */
     ...
     * @return \Oasis\Model\Raw\Brands
     */
    public function addTargetPatterns(\Oasis\Model\Raw\TargetPatterns $data)
    {
     ...
     * @param string or array $orderBy
     * @param boolean $avoidLoading skip data loading if it is not already
     * @return array The array of \Oasis\Model\Raw\TargetPatterns
     */
     ...
     *
     * @param array $data An array of \Oasis\Model\Raw\TransformationRulesetGroupsTrunks
     * @return \Oasis\Model\Raw\Brands
     */
     ...
     * @return \Oasis\Model\Raw\Brands
     */
    public function addTransformationRulesetGroupsTrunks(\Oasis\Model\Raw\TransformationRulesetGroupsTrunks $data)
    {
     ...
     * @param string or array $orderBy
     * @param boolean $avoidLoading skip data loading if it is not already
     * @return array The array of \Oasis\Model\Raw\TransformationRulesetGroupsTrunks
     */
     ...
     *
     * @param array $data An array of \Oasis\Model\Raw\TransformationRulesetGroupsUsers
     * @return \Oasis\Model\Raw\Brands
     */
     ...
     * @return \Oasis\Model\Raw\Brands
     */
    public function addTransformationRulesetGroupsUsers(\Oasis\Model\Raw\TransformationRulesetGroupsUsers $data)
    {
     ...
     * @param string or array $orderBy
     * @param boolean $avoidLoading skip data loading if it is not already
     * @return array The array of \Oasis\Model\Raw\TransformationRulesetGroupsUsers
     */
     ...
     *
     * @param array $data An array of \Oasis\Model\Raw\KamTrunksUacreg
     * @return \Oasis\Model\Raw\Brands
     */
     ...
     * Sets dependent relations kam_trunks_uacreg_ibfk_1
     *
     * @param \Oasis\Model\Raw\KamTrunksUacreg $data
     * @return \Oasis\Model\Raw\Brands
     */
    public function addKamTrunksUacreg(\Oasis\Model\Raw\KamTrunksUacreg $data)
    {
     ...
     * @param string or array $orderBy
     * @param boolean $avoidLoading skip data loading if it is not already
     * @return array The array of \Oasis\Model\Raw\KamTrunksUacreg
     */
     ...
     *
     * @return Oasis\Mapper\Sql\Brands
     */
    public function getMapper()
    {
        if ($this->_mapper === null) {
            ...
            if (class_exists('\Oasis\Mapper\Sql\Brands')) {

                $this->setMapper(new \Oasis\Mapper\Sql\Brands);
     ...
     *
     * @return null | \Oasis\Model\Validator\Brands
     */
    public function getValidator()
    {
        if ($this->_validator === null) {

            if (class_exists('\Oasis\\Validator\Brands')) {

                $this->setValidator(new \Oasis\Validator\Brands);
            }
        }
