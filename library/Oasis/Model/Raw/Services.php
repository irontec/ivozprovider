...
class Services extends ModelAbstract
{
    ...
    ***************************************************************************/
     ...
     * @param binary $data
     * @return \Oasis\Model\Raw\Services
     */
     ...
     *
     * @return Oasis\Mapper\Sql\Services
     */
    public function getMapper()
    {
        if ($this->_mapper === null) {
            ...
            if (class_exists('\Oasis\Mapper\Sql\Services')) {

                $this->setMapper(new \Oasis\Mapper\Sql\Services);
     ...
     *
     * @return null | \Oasis\Model\Validator\Services
     */
    public function getValidator()
    {
        if ($this->_validator === null) {

            if (class_exists('\Oasis\\Validator\Services')) {

                $this->setValidator(new \Oasis\Validator\Services);
            }
        }
