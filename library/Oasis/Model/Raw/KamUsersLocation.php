...
class KamUsersLocation extends ModelAbstract
{
    ...
    ***************************************************************************/
     ...
     * @param int $data
     * @return \Oasis\Model\Raw\KamUsersLocation
     */
     ...
     *
     * @return Oasis\Mapper\Sql\KamUsersLocation
     */
    public function getMapper()
    {
        if ($this->_mapper === null) {
            ...
            if (class_exists('\Oasis\Mapper\Sql\KamUsersLocation')) {

                $this->setMapper(new \Oasis\Mapper\Sql\KamUsersLocation);
     ...
     *
     * @return null | \Oasis\Model\Validator\KamUsersLocation
     */
    public function getValidator()
    {
        if ($this->_validator === null) {

            if (class_exists('\Oasis\\Validator\KamUsersLocation')) {

                $this->setValidator(new \Oasis\Validator\KamUsersLocation);
            }
        }
