...
class BrandURLs extends ModelAbstract
{
    ...
    ***************************************************************************/
     ...
     * @param int $data
     * @return \Oasis\Model\Raw\BrandURLs
     */
     ...
     *
     * @return Oasis\Mapper\Sql\BrandURLs
     */
    public function getMapper()
    {
        if ($this->_mapper === null) {
            ...
            if (class_exists('\Oasis\Mapper\Sql\BrandURLs')) {

                $this->setMapper(new \Oasis\Mapper\Sql\BrandURLs);
     ...
     *
     * @return null | \Oasis\Model\Validator\BrandURLs
     */
    public function getValidator()
    {
        if ($this->_validator === null) {

            if (class_exists('\Oasis\\Validator\BrandURLs')) {

                $this->setValidator(new \Oasis\Validator\BrandURLs);
            }
        }
