...
abstract class ModelAbstract implements \IteratorAggregate
{
     ...
     *
     * @var Oasis\Model\Raw\ModelAbstract
     */
    protected $_mapper;
    ...
    */
     ...
     *
     * @var Oasis\Model\ModelValidatorAbstract
     */
     ...
     *
     * @param array $data
     * @return Oasis\Model\Raw\ModelAbstract
     */
     ...
     *
     * @return Oasis\Model\Mapper\MapperAbstract
     */
     ...
     *
     * @param Oasis\Model\Mapper\MapperAbstract $mapper
     * @return Oasis\Model\Raw\ModelAbstract
     */
     ...
     *
     * @see Oasis\Mapper\DbTable\TableAbstract::getPrimaryKeyName()
     ...
     *
     * @see Oasis\Model\Mapper\MapperAbstract::toArray()
     * @return array
     */
     ...
     * Saves current row
     *
     * @see Oasis\Model\Mapper\MapperAbstract::save()
     ...
     *
     * @see Oasis\Model\Mapper\MapperAbstract::saveRecursive()
