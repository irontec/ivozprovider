...
class PricingPlansRelCompanies extends ModelAbstract
{
    ...
    ***************************************************************************/
     ...
     * @param int $data
     * @return \Oasis\Model\Raw\PricingPlansRelCompanies
     */
     ...
     *
     * @return Oasis\Mapper\Sql\PricingPlansRelCompanies
     */
    public function getMapper()
    {
        if ($this->_mapper === null) {
            ...
            if (class_exists('\Oasis\Mapper\Sql\PricingPlansRelCompanies')) {

                $this->setMapper(new \Oasis\Mapper\Sql\PricingPlansRelCompanies);
     ...
     *
     * @return null | \Oasis\Model\Validator\PricingPlansRelCompanies
     */
    public function getValidator()
    {
        if ($this->_validator === null) {

            if (class_exists('\Oasis\\Validator\PricingPlansRelCompanies')) {

                $this->setValidator(new \Oasis\Validator\PricingPlansRelCompanies);
            }
        }
