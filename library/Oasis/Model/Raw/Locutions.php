...
class Locutions extends ModelAbstract
{
    ...
    ***************************************************************************/
     ...
     * @param binary $data
     * @return \Oasis\Model\Raw\Locutions
     */
     ...
     * @return \Oasis\Model\Raw\Locutions
     */
    public function addExternalCallFiltersByWelcomeLocution(\Oasis\Model\Raw\ExternalCallFilters $data)
    {
     ...
     * @return \Oasis\Model\Raw\Locutions
     */
    public function addExternalCallFiltersByHolidayLocution(\Oasis\Model\Raw\ExternalCallFilters $data)
    {
     ...
     * @return \Oasis\Model\Raw\Locutions
     */
    public function addExternalCallFiltersByOutOfScheduleLocution(\Oasis\Model\Raw\ExternalCallFilters $data)
    {
     ...
     * @return \Oasis\Model\Raw\Locutions
     */
    public function addIVRCommonByWelcomeLocution(\Oasis\Model\Raw\IVRCommon $data)
    {
     ...
     * @return \Oasis\Model\Raw\Locutions
     */
    public function addIVRCommonByNoAnswerLocution(\Oasis\Model\Raw\IVRCommon $data)
    {
     ...
     * @return \Oasis\Model\Raw\Locutions
     */
    public function addIVRCommonByErrorLocution(\Oasis\Model\Raw\IVRCommon $data)
    {
     ...
     * @return \Oasis\Model\Raw\Locutions
     */
    public function addIVRCommonBySuccessLocution(\Oasis\Model\Raw\IVRCommon $data)
    {
     ...
     * @return \Oasis\Model\Raw\Locutions
     */
    public function addIVRCustomByWelcomeLocution(\Oasis\Model\Raw\IVRCustom $data)
    {
     ...
     * @return \Oasis\Model\Raw\Locutions
     */
    public function addIVRCustomByNoAnswerLocution(\Oasis\Model\Raw\IVRCustom $data)
    {
     ...
     * @return \Oasis\Model\Raw\Locutions
     */
    public function addIVRCustomByErrorLocution(\Oasis\Model\Raw\IVRCustom $data)
    {
     ...
     * @return \Oasis\Model\Raw\Locutions
     */
    public function addIVRCustomBySuccessLocution(\Oasis\Model\Raw\IVRCustom $data)
    {
     ...
     *
     * @return Oasis\Mapper\Sql\Locutions
     */
    public function getMapper()
    {
        if ($this->_mapper === null) {
            ...
            if (class_exists('\Oasis\Mapper\Sql\Locutions')) {

                $this->setMapper(new \Oasis\Mapper\Sql\Locutions);
     ...
     *
     * @return null | \Oasis\Model\Validator\Locutions
     */
    public function getValidator()
    {
        if ($this->_validator === null) {

            if (class_exists('\Oasis\\Validator\Locutions')) {

                $this->setValidator(new \Oasis\Validator\Locutions);
            }
        }
