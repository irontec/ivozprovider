...
class KamUsersHtable extends ModelAbstract
{
    ...
    ***************************************************************************/
     ...
     * @param int $data
     * @return \Oasis\Model\Raw\KamUsersHtable
     */
     ...
     *
     * @return Oasis\Mapper\Sql\KamUsersHtable
     */
    public function getMapper()
    {
        if ($this->_mapper === null) {
            ...
            if (class_exists('\Oasis\Mapper\Sql\KamUsersHtable')) {

                $this->setMapper(new \Oasis\Mapper\Sql\KamUsersHtable);
     ...
     *
     * @return null | \Oasis\Model\Validator\KamUsersHtable
     */
    public function getValidator()
    {
        if ($this->_validator === null) {

            if (class_exists('\Oasis\\Validator\KamUsersHtable')) {

                $this->setValidator(new \Oasis\Validator\KamUsersHtable);
            }
        }
     ...
     *
     * @see \Mapper\Sql\KamUsersHtable::delete
