...
class KamUsersAcc extends ModelAbstract
{
    ...
    ***************************************************************************/
     ...
     * @param int $data
     * @return \Oasis\Model\Raw\KamUsersAcc
     */
     ...
     *
     * @return Oasis\Mapper\Sql\KamUsersAcc
     */
    public function getMapper()
    {
        if ($this->_mapper === null) {
            ...
            if (class_exists('\Oasis\Mapper\Sql\KamUsersAcc')) {

                $this->setMapper(new \Oasis\Mapper\Sql\KamUsersAcc);
     ...
     *
     * @return null | \Oasis\Model\Validator\KamUsersAcc
     */
    public function getValidator()
    {
        if ($this->_validator === null) {

            if (class_exists('\Oasis\\Validator\KamUsersAcc')) {

                $this->setValidator(new \Oasis\Validator\KamUsersAcc);
            }
        }
     ...
     *
     * @see \Mapper\Sql\KamUsersAcc::delete
