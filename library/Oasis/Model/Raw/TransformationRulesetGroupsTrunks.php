...
class TransformationRulesetGroupsTrunks extends ModelAbstract
{
     ...
     * Type: One-to-Many relationship
     *
     * @var \Oasis\Model\Raw\KamTrunksDialplan[]
     */
    ...
    ***************************************************************************/
     ...
     *
     * @param array $data An array of \Oasis\Model\Raw\KamTrunksDialplan
     * @return \Oasis\Model\Raw\TransformationRulesetGroupsTrunks
     */
     ...
     * Sets dependent relations kam_trunks_dialplan_ibfk_2
     *
     * @param \Oasis\Model\Raw\KamTrunksDialplan $data
     * @return \Oasis\Model\Raw\TransformationRulesetGroupsTrunks
     */
    public function addKamTrunksDialplan(\Oasis\Model\Raw\KamTrunksDialplan $data)
    {
     ...
     * @param string or array $orderBy
     * @param boolean $avoidLoading skip data loading if it is not already
     * @return array The array of \Oasis\Model\Raw\KamTrunksDialplan
     */
     ...
     *
     * @return Oasis\Mapper\Sql\TransformationRulesetGroupsTrunks
     */
    public function getMapper()
    {
        if ($this->_mapper === null) {
            ...
            if (class_exists('\Oasis\Mapper\Sql\TransformationRulesetGroupsTrunks')) {

                $this->setMapper(new \Oasis\Mapper\Sql\TransformationRulesetGroupsTrunks);
     ...
     *
     * @return null | \Oasis\Model\Validator\TransformationRulesetGroupsTrunks
     */
    public function getValidator()
    {
        if ($this->_validator === null) {

            if (class_exists('\Oasis\\Validator\TransformationRulesetGroupsTrunks')) {

                $this->setValidator(new \Oasis\Validator\TransformationRulesetGroupsTrunks);
            }
        }
