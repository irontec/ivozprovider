...
class TerminalModels extends ModelAbstract
{
     ...
     *
     * @var \Oasis\Model\Raw\TerminalManufacturers
     */
    ...
    ***************************************************************************/
     ...
     *
     * @param \Oasis\Model\Raw\TerminalManufacturers $data
     * @return \Oasis\Model\Raw\TerminalModels
     */
    public function setTerminalManufacturer(\Oasis\Model\Raw\TerminalManufacturers $data)
    {
     ...
     *
     * @return Oasis\Mapper\Sql\TerminalModels
     */
    public function getMapper()
    {
        if ($this->_mapper === null) {
            ...
            if (class_exists('\Oasis\Mapper\Sql\TerminalModels')) {

                $this->setMapper(new \Oasis\Mapper\Sql\TerminalModels);
     ...
     *
     * @return null | \Oasis\Model\Validator\TerminalModels
     */
    public function getValidator()
    {
        if ($this->_validator === null) {

            if (class_exists('\Oasis\\Validator\TerminalModels')) {

                $this->setValidator(new \Oasis\Validator\TerminalModels);
            }
        }
