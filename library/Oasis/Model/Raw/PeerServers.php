...
class PeerServers extends ModelAbstract
{
     ...
     * Type: One-to-Many relationship
     *
     * @var \Oasis\Model\Raw\KamAddress[]
     */
    ...
    ***************************************************************************/
     ...
     *
     * @param array $data An array of \Oasis\Model\Raw\KamAddress
     * @return \Oasis\Model\Raw\PeerServers
     */
     ...
     * Sets dependent relations kam_address_ibfk_1
     *
     * @param \Oasis\Model\Raw\KamAddress $data
     * @return \Oasis\Model\Raw\PeerServers
     */
    public function addKamAddress(\Oasis\Model\Raw\KamAddress $data)
    {
     ...
     * @param string or array $orderBy
     * @param boolean $avoidLoading skip data loading if it is not already
     * @return array The array of \Oasis\Model\Raw\KamAddress
     */
     ...
     *
     * @return Oasis\Mapper\Sql\PeerServers
     */
    public function getMapper()
    {
        if ($this->_mapper === null) {
            ...
            if (class_exists('\Oasis\Mapper\Sql\PeerServers')) {

                $this->setMapper(new \Oasis\Mapper\Sql\PeerServers);
     ...
     *
     * @return null | \Oasis\Model\Validator\PeerServers
     */
    public function getValidator()
    {
        if ($this->_validator === null) {

            if (class_exists('\Oasis\\Validator\PeerServers')) {

                $this->setValidator(new \Oasis\Validator\PeerServers);
            }
        }
