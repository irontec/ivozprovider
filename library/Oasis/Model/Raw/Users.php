...
class Users extends ModelAbstract
{
     ...
     * Type: One-to-Many relationship
     *
     * @var \Oasis\Model\Raw\PickUpRelUsers[]
     */
    ...
    ***************************************************************************/
     ...
     * @return \Oasis\Model\Raw\Users
     */
    public function setBossAssistant(\Oasis\Model\Raw\Users $data)
    {
     ...
     * @return \Oasis\Model\Raw\Users
     */
    public function setTerminal(\Oasis\Model\Raw\Terminals $data)
    {
        $this->_Terminal = $data;
     ...
     * @return \Oasis\Model\Raw\Users
     */
    public function setExtension(\Oasis\Model\Raw\Extensions $data)
    {
     ...
     * @return \Oasis\Model\Raw\Users
     */
    public function setOutgoingDDI(\Oasis\Model\Raw\DDIs $data)
    {
     ...
     * @return \Oasis\Model\Raw\Users
     */
    public function addCallForwardSettingsByUser(\Oasis\Model\Raw\CallForwardSettings $data)
    {
     ...
     * @return \Oasis\Model\Raw\Users
     */
    public function addCallForwardSettingsByVoiceMailUser(\Oasis\Model\Raw\CallForwardSettings $data)
    {
     ...
     * @return \Oasis\Model\Raw\Users
     */
    public function addExternalCallFiltersByHolidayVoiceMailUser(\Oasis\Model\Raw\ExternalCallFilters $data)
    {
     ...
     * @return \Oasis\Model\Raw\Users
     */
    public function addExternalCallFiltersByOutOfScheduleVoiceMailUser(\Oasis\Model\Raw\ExternalCallFilters $data)
    {
     ...
     * @return \Oasis\Model\Raw\Users
     */
    public function addIVRCommonByErrorVoiceMailUser(\Oasis\Model\Raw\IVRCommon $data)
    {
     ...
     * @return \Oasis\Model\Raw\Users
     */
    public function addIVRCustomByErrorVoiceMailUser(\Oasis\Model\Raw\IVRCustom $data)
    {
     ...
     *
     * @param array $data An array of \Oasis\Model\Raw\PickUpRelUsers
     * @return \Oasis\Model\Raw\Users
     */
     ...
     * Sets dependent relations PickUpRelUsers_ibfk_2
     *
     * @param \Oasis\Model\Raw\PickUpRelUsers $data
     * @return \Oasis\Model\Raw\Users
     */
    public function addPickUpRelUsers(\Oasis\Model\Raw\PickUpRelUsers $data)
    {
     ...
     * @param string or array $orderBy
     * @param boolean $avoidLoading skip data loading if it is not already
     * @return array The array of \Oasis\Model\Raw\PickUpRelUsers
     */
    ...
    public function getMapper()
    {
        if ($this->_mapper === null) {
            ...
            if (class_exists('\Oasis\Mapper\Sql\Users')) {

                $this->setMapper(new \Oasis\Mapper\Sql\Users);
     ...
     *
     * @return null | \Oasis\Model\Validator\Users
     */
    public function getValidator()
    {
        if ($this->_validator === null) {

            if (class_exists('\Oasis\\Validator\Users')) {

                $this->setValidator(new \Oasis\Validator\Users);
            }
        }
