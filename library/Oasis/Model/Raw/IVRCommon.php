...
class IVRCommon extends ModelAbstract
{
    ...
    ***************************************************************************/
     ...
     *
     * @return Oasis\Mapper\Sql\IVRCommon
     */
    public function getMapper()
    {
        if ($this->_mapper === null) {
            ...
            if (class_exists('\Oasis\Mapper\Sql\IVRCommon')) {

                $this->setMapper(new \Oasis\Mapper\Sql\IVRCommon);
     ...
     *
     * @return null | \Oasis\Model\Validator\IVRCommon
     */
    public function getValidator()
    {
        if ($this->_validator === null) {

            if (class_exists('\Oasis\\Validator\IVRCommon')) {

                $this->setValidator(new \Oasis\Validator\IVRCommon);
            }
        }
