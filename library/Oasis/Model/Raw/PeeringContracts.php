...
class PeeringContracts extends ModelAbstract
{
    ...
    ***************************************************************************/
     ...
     *
     * @return Oasis\Mapper\Sql\PeeringContracts
     */
    public function getMapper()
    {
        if ($this->_mapper === null) {
            ...
            if (class_exists('\Oasis\Mapper\Sql\PeeringContracts')) {

                $this->setMapper(new \Oasis\Mapper\Sql\PeeringContracts);
     ...
     *
     * @return null | \Oasis\Model\Validator\PeeringContracts
     */
    public function getValidator()
    {
        if ($this->_validator === null) {

            if (class_exists('\Oasis\\Validator\PeeringContracts')) {

                $this->setValidator(new \Oasis\Validator\PeeringContracts);
            }
        }
