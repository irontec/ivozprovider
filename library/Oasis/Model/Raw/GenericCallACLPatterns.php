...
class GenericCallACLPatterns extends ModelAbstract
{
    ...
    ***************************************************************************/
     ...
     * @param binary $data
     * @return \Oasis\Model\Raw\GenericCallACLPatterns
     */
     ...
     *
     * @return Oasis\Mapper\Sql\GenericCallACLPatterns
     */
    public function getMapper()
    {
        if ($this->_mapper === null) {
            ...
            if (class_exists('\Oasis\Mapper\Sql\GenericCallACLPatterns')) {

                $this->setMapper(new \Oasis\Mapper\Sql\GenericCallACLPatterns);
     ...
     *
     * @return null | \Oasis\Model\Validator\GenericCallACLPatterns
     */
    public function getValidator()
    {
        if ($this->_validator === null) {

            if (class_exists('\Oasis\\Validator\GenericCallACLPatterns')) {

                $this->setValidator(new \Oasis\Validator\GenericCallACLPatterns);
            }
        }
