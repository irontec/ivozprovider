...
class Countries extends ModelAbstract
{
    ...
    ***************************************************************************/
     ...
     *
     * @param array $data An array of \Oasis\Model\Raw\Timezones
     * @return \Oasis\Model\Raw\Countries
     */
     ...
     * @return \Oasis\Model\Raw\Countries
     */
    public function addTimezones(\Oasis\Model\Raw\Timezones $data)
    {
     ...
     * @param string or array $orderBy
     * @param boolean $avoidLoading skip data loading if it is not already
     * @return array The array of \Oasis\Model\Raw\Timezones
     */
     ...
     *
     * @return Oasis\Mapper\Sql\Countries
     */
    public function getMapper()
    {
        if ($this->_mapper === null) {
            ...
            if (class_exists('\Oasis\Mapper\Sql\Countries')) {

                $this->setMapper(new \Oasis\Mapper\Sql\Countries);
     ...
     *
     * @return null | \Oasis\Model\Validator\Countries
     */
    public function getValidator()
    {
        if ($this->_validator === null) {

            if (class_exists('\Oasis\\Validator\Countries')) {

                $this->setValidator(new \Oasis\Validator\Countries);
            }
        }
