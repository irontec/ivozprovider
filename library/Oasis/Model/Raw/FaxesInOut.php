...
class FaxesInOut extends ModelAbstract
{
    ...
    ***************************************************************************/
     ...
     * @param binary $data
     * @return \Oasis\Model\Raw\FaxesInOut
     */
     ...
     *
     * @return Oasis\Mapper\Sql\FaxesInOut
     */
    public function getMapper()
    {
        if ($this->_mapper === null) {
            ...
            if (class_exists('\Oasis\Mapper\Sql\FaxesInOut')) {

                $this->setMapper(new \Oasis\Mapper\Sql\FaxesInOut);
     ...
     *
     * @return null | \Oasis\Model\Validator\FaxesInOut
     */
    public function getValidator()
    {
        if ($this->_validator === null) {

            if (class_exists('\Oasis\\Validator\FaxesInOut')) {

                $this->setValidator(new \Oasis\Validator\FaxesInOut);
            }
        }
