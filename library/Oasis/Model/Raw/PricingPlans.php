...
class PricingPlans extends ModelAbstract
{
    ...
    ***************************************************************************/
     ...
     *
     * @return Oasis\Mapper\Sql\PricingPlans
     */
    public function getMapper()
    {
        if ($this->_mapper === null) {
            ...
            if (class_exists('\Oasis\Mapper\Sql\PricingPlans')) {

                $this->setMapper(new \Oasis\Mapper\Sql\PricingPlans);
     ...
     *
     * @return null | \Oasis\Model\Validator\PricingPlans
     */
    public function getValidator()
    {
        if ($this->_validator === null) {

            if (class_exists('\Oasis\\Validator\PricingPlans')) {

                $this->setValidator(new \Oasis\Validator\PricingPlans);
            }
        }
