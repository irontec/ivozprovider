...
class IVRCustom extends ModelAbstract
{
    ...
    ***************************************************************************/
     ...
     * @return \Oasis\Model\Raw\IVRCustom
     */
    public function setNoAnswerLocution(\Oasis\Model\Raw\Locutions $data)
    {
     ...
     * @return \Oasis\Model\Raw\IVRCustom
     */
    public function setErrorLocution(\Oasis\Model\Raw\Locutions $data)
    {
     ...
     * @return \Oasis\Model\Raw\IVRCustom
     */
    public function setSuccessLocution(\Oasis\Model\Raw\Locutions $data)
    {
     ...
     * @return \Oasis\Model\Raw\IVRCustom
     */
    public function setTimeoutExtension(\Oasis\Model\Raw\Extensions $data)
    {
     ...
     * @return \Oasis\Model\Raw\IVRCustom
     */
    public function setErrorExtension(\Oasis\Model\Raw\Extensions $data)
    {
     ...
     * @return \Oasis\Model\Raw\IVRCustom
     */
    public function setTimeoutVoiceMailUser(\Oasis\Model\Raw\Users $data)
    {
     ...
     *
     * @return Oasis\Mapper\Sql\IVRCustom
     */
    public function getMapper()
    {
        if ($this->_mapper === null) {
            ...
            if (class_exists('\Oasis\Mapper\Sql\IVRCustom')) {

                $this->setMapper(new \Oasis\Mapper\Sql\IVRCustom);
     ...
     *
     * @return null | \Oasis\Model\Validator\IVRCustom
     */
    public function getValidator()
    {
        if ($this->_validator === null) {

            if (class_exists('\Oasis\\Validator\IVRCustom')) {

                $this->setValidator(new \Oasis\Validator\IVRCustom);
            }
        }
