...
class Schedules extends ModelAbstract
{
    ...
    ***************************************************************************/
     ...
     *
     * @return Oasis\Mapper\Sql\Schedules
     */
    public function getMapper()
    {
        if ($this->_mapper === null) {
            ...
            if (class_exists('\Oasis\Mapper\Sql\Schedules')) {

                $this->setMapper(new \Oasis\Mapper\Sql\Schedules);
     ...
     *
     * @return null | \Oasis\Model\Validator\Schedules
     */
    public function getValidator()
    {
        if ($this->_validator === null) {

            if (class_exists('\Oasis\\Validator\Schedules')) {

                $this->setValidator(new \Oasis\Validator\Schedules);
            }
        }
