...
class TerminalManufacturers extends ModelAbstract
{
    ...
    ***************************************************************************/
     ...
     * @param binary $data
     * @return \Oasis\Model\Raw\TerminalManufacturers
     */
     ...
     *
     * @param array $data An array of \Oasis\Model\Raw\TerminalModels
     * @return \Oasis\Model\Raw\TerminalManufacturers
     */
     ...
     * @return \Oasis\Model\Raw\TerminalManufacturers
     */
    public function addTerminalModels(\Oasis\Model\Raw\TerminalModels $data)
    {
     ...
     * @return array The array of \Oasis\Model\Raw\TerminalModels
     */
     ...
     *
     * @return Oasis\Mapper\Sql\TerminalManufacturers
     */
    public function getMapper()
    {
        if ($this->_mapper === null) {
            ...
            if (class_exists('\Oasis\Mapper\Sql\TerminalManufacturers')) {

                $this->setMapper(new \Oasis\Mapper\Sql\TerminalManufacturers);
     ...
     *
     * @return null | \Oasis\Model\Validator\TerminalManufacturers
     */
    public function getValidator()
    {
        if ($this->_validator === null) {

            if (class_exists('\Oasis\\Validator\TerminalManufacturers')) {

                $this->setValidator(new \Oasis\Validator\TerminalManufacturers);
            }
        }
