...
class KamUsersAddress extends ModelAbstract
{
    ...
    ***************************************************************************/
     ...
     * @param int $data
     * @return \Oasis\Model\Raw\KamUsersAddress
     */
     ...
     *
     * @return Oasis\Mapper\Sql\KamUsersAddress
     */
    public function getMapper()
    {
        if ($this->_mapper === null) {
            ...
            if (class_exists('\Oasis\Mapper\Sql\KamUsersAddress')) {

                $this->setMapper(new \Oasis\Mapper\Sql\KamUsersAddress);
     ...
     *
     * @return null | \Oasis\Model\Validator\KamUsersAddress
     */
    public function getValidator()
    {
        if ($this->_validator === null) {

            if (class_exists('\Oasis\\Validator\KamUsersAddress')) {

                $this->setValidator(new \Oasis\Validator\KamUsersAddress);
            }
        }
