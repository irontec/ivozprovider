...
class Paginator extends \Zend_Paginator_Adapter_DbSelect
{
     ...
     * Object mapper
     *
     * @var Oasis\Mapper\Sql\Raw\MapperAbstract
     */
     ...
     * @param Oasis\Mapper\Sql\Raw\MapperAbstract $mapper The mapper associated with the object type
     */
    public function __construct(\Zend_Db_Select $select, \Oasis\Mapper\Sql\Raw\MapperAbstract $mapper)
    {
        $this->_mapper = $mapper;
     ...
     * @return array An array of Oasis\\Raw\ModelAbstract objects
     */
