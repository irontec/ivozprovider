...
class Oasis_Klear_Filter_ExternalCallFiltersMultiselect implements KlearMatrix_Model_Field_Select_Filter_Interface
{
    ...
    public function setRouteDispatcher(KlearMatrix_Model_RouteDispatcher $routeDispatcher)
    {
        ...
        switch ($currentItemName) {
            ...
            case "calendarsEdit_screen":
                if ($pk) {
                    $calendarsMapper = new \Oasis\Mapper\Sql\Calendars();
            ...
            case "schedulesEdit_screen":
                if ($pk && $parentScreen) {
                    $schedulesMapper = new \Oasis\Mapper\Sql\Schedules();
