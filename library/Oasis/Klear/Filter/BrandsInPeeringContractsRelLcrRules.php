<?php
class Oasis_Klear_Filter_BrandsInPeeringContractsRelLcrRules implements KlearMatrix_Model_Field_Select_Filter_Interface
{
    ...
    public function setRouteDispatcher(KlearMatrix_Model_RouteDispatcher $routeDispatcher)
    {
        ...
        if ($camingFromParentScreen && $isEditableScreen) {
            ...
            if ('PeeringContractsList' == $file) {
                ...
                $peeringContractMapper = new \Oasis\Mapper\Sql\PeeringContracts;
                ...
                $lcrRulesMapper = new \Oasis\Mapper\Sql\LcrRules;
