...
class Oasis_Klear_Filter_HolidayDateSelectLocution implements KlearMatrix_Model_Field_Select_Filter_Interface
{
    ...
    public function setRouteDispatcher(KlearMatrix_Model_RouteDispatcher $routeDispatcher)
    {
        ...
        switch ($currentItemName) {
            case "holidayDatesNew_screen":
                if ($parentId) {
                    $calendarMapper = new \Oasis\Mapper\Sql\Calendars();
            ...
            case "holidayDatesEdit_screen":
                if ($pk) {
                    $holidayMapper = new \Oasis\Mapper\Sql\HolidayDates();
