...
{
    /**
     * $_dbTable - instance of Oasis\Mapper\DbTable\TableAbstract
     *
     * @var Oasis\Mapper\DbTable\TableAbstract
     */
    protected $_dbTable;
     ...
     *
     * @param Oasis\Mapper\DbTable\TableAbstract $dbTable
     * @return Oasis\Mapper\Sql\Raw\MapperAbstract
     */
     ...
     * @param Oasis\Model\Raw\ModelAbstract $model
    ...
    public function loadRelated($type, $name, $model, $conditions = null, $orderBy = null)
    {
        ...
        if ('parent' == $type && array_key_exists($name, $parents)) {
            ...
            $table_class = 'Oasis\\Mapper\\Sql\\DbTable\\' . $object_table_name;
            $rule = $name;
            ...
            $ref_table_name = 'Oasis\\Mapper\\Sql\\DbTable\\' . $object_table_name;
            $rule = $name;
        } else {
        ...
        if ($this->_cache &&
            ...
            $relMapperClassName = "\\Oasis\\Mapper\\Sql\\" . $object_table_name;
     ...
     *
     * @see Oasis\Mapper\DbTable\TableAbstract::countAllRows()
     ...
     *
     * @see Oasis\Mapper\DbTable\TableAbstract::countByQuery()
     ...
     *
     * @param Oasis\Model\Raw\ModelAbstract $model The model to delete
     * @return int
     */
    public abstract function delete(\Oasis\Model\Raw\ModelAbstract $model);
    ...
    {
        $adapter = new \Oasis\Model\Paginator($select, $this);
     ...
     * @return Oasis\Model\Raw\ModelAbstract|null
     */
     ...
     * @return array All Oasis\Model\Raw\ModelAbstract meeting the criteria
     */
     ...
     * @param Oasis\Model\Raw\ModelAbstract|null $model
     * @return Oasis\Model\Raw\ModelAbstract|null The matching models found or null if not found
     */
     ...
     *
     * @return Oasis\Mapper\DbTable\TableAbstract
     */
     ...
     *
     * @param new Oasis\Model\Raw\ModelAbstract $model
     * @return array
     */
     ...
     * @param Oasis\Model\Raw\ModelAbstract|null $entry The object to load the data into, or null to have one created
     */
    protected abstract function loadModel($data, $entry);

    /**
     * Cleans urlIdentifier fields, so they can be used as url slugs
     * @param \Oasis\Model\Raw\ModelAbstract $model The model to clean
     *
     */
    protected function _setCleanUrlIdentifiers(\Oasis\Model\Raw\ModelAbstract $model)
    {
