...
/**
 * Table definition for kam_users_dialog
 *
 * @package Oasis\Mapper\Sql\DbTable
 * @subpackage DbTable
 * @author Luis Felipe Garcia
...
class KamUsersDialog extends TableAbstract
{
    /**
     ...
     * @var string
     */
    protected $_name = 'kam_users_dialog';
    ...
    protected $_rowClass = 'Oasis\\Model\\KamUsersDialog';
    protected $_rowMapperClass = 'Oasis\\Mapper\\Sql\\KamUsersDialog';
