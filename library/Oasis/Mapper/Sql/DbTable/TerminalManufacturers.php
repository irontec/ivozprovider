...
class TerminalManufacturers extends TableAbstract
{
    ...
    protected $_rowClass = 'Oasis\\Model\\TerminalManufacturers';
    protected $_rowMapperClass = 'Oasis\\Mapper\\Sql\\TerminalManufacturers';

    protected $_sequence = true; // binary
    
    protected $_dependentTables = array(
        'Oasis\\Mapper\\Sql\\DbTable\\TerminalModels'
    );
