...
import { StyledTemplateAction, StyledTextAreaContainer, StyledTextArea, StyledMacInputContainer, StyledErrorContainer } from '../TemplateAction.styles';
              ...
              {!running && (
                <>
                  ...
                  <StyledTextAreaContainer>
                    <StyledTextArea
                      defaultValue={result ? result : formik?.initialValues.specificTemplate}
                      readOnly={true}
                    />
