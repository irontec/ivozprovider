...
import { StyledTemplateAction, StyledErrorContainer } from '../TemplateAction.styles';
...
const Restore = (props: PropsType): JSX.Element => {
  ...
  const handleRestore = () => {
    ...
    apiGet({
      path: `${TerminalModel.path}/${match.params.id}/default_template?type=generic`,
      params: {},
      handleErrors: false,
      successCallback: async (response) => {
        formik?.setFieldValue('genericTemplate', response);
        handleClose();
      },
    })
