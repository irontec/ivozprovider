...
type RecordingExtensionType = PropertyCustomFunctionComponent<
  PropertyCustomFunctionComponentProps<
    RecordingExtensionValues & { className: string }
  >
>;

const RecordingExtension: RecordingExtensionType = (
  props
): JSX.Element | null => {
...
export default withCustomComponentWrapper<RecordingExtensionValues>(
  StyledRecordingExtension
);
