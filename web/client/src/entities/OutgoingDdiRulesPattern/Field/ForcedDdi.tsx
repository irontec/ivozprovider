...
>;
type TargetGhostType = PropertyCustomFunctionComponent<PropertyCustomFunctionComponentProps<OutgoingDdiRulesPatternValues>>;
...
export default withCustomComponentWrapper<OutgoingDdiRulesPatternValues>(Target);