...
>;
type ForcedDdiStrType = PropertyCustomFunctionComponent<PropertyCustomFunctionComponentProps<OutgoingDdiRulesPatternValues>>;
...
export default withCustomComponentWrapper<OutgoingDdiRulesPatternValues>(ForcedDdiStr);