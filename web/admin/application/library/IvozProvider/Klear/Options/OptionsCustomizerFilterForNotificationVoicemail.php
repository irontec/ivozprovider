...
class IvozProvider_Klear_Options_OptionsCustomizerFilterForNotificationVoicemail implements \KlearMatrix_Model_Interfaces_ParentOptionCustomizer
{
    /**
    ...
    public function customize($parentModel)
    {
        ...
        if ($optionName == 'notificationTemplatesContentsVoicemailList_screen' && $type != 'voicemail') {
