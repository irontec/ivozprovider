...
class IvozProvider_Klear_Options_OptionsCustomizerFilterForNotificationMaxDailyUsage implements \KlearMatrix_Model_Interfaces_ParentOptionCustomizer
{
    /**
    ...
    public function customize($parentModel)
    {
        ...
        if ($optionName == 'notificationTemplatesContentsMaxDailyUsageList_screen' && $type != 'maxDailyUsage') {
