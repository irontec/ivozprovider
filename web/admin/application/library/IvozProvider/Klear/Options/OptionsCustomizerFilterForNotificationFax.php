...
class IvozProvider_Klear_Options_OptionsCustomizerFilterForNotificationFax implements \KlearMatrix_Model_Interfaces_ParentOptionCustomizer
{
    /**
    ...
    public function customize($parentModel)
    {
        ...
        if ($optionName == 'notificationTemplatesContentsFaxList_screen' && $type != 'fax') {
