...
class IvozProvider_Klear_Filter_CallCsvSchedulerCompany extends IvozProvider_Klear_Filter_Brand
{
    ...
    public function setRouteDispatcher(KlearMatrix_Model_RouteDispatcher $routeDispatcher)
    {
        ...
        $companyIdsInUse = $dataGateway->runNamedQuery(
            \Ivoz\Provider\Domain\Model\CallCsvScheduler\CallCsvScheduler::class,
            'getCompanyIdsInUse',
            [$schedulerId]
        );
