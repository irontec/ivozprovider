...
Background:
  Given I am on the Dashboard
   ...
   When I click on "Brands" first elements "webPortals" button
   Then I am on "BrandsList_webPortals" subscreen list
...
Scenario: I can create brand operators
  ...
  Then I am on "BrandsList_webPortals" subscreen list
  When I click on "webPortals" last elements edit button
  Then I compare the form data with "platform/webPortal/new" data fixture

Scenario: I can save brand urls
  Given I can see at least one row
   When I click on "webPortals" first elements edit button
    And I click on save button
   Then I can see confirmation dialog
   When I click on close dialog button
   Then I am on "BrandsList_webPortals" subscreen list
...
Scenario: I can click on delete brand button
  Given I can see at least one row
   When I click on "webPortals" first elements delete button
   Then I can see confirmation dialog
   When I click on close dialog button
   Then I am on "BrandsList_webPortals" subscreen list
