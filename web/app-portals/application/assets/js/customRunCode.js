;(function load($) {
    ...
    var __namespace__ = "custom.RunCode";
    $.custom = $.custom || {};

    $.widget("custom.RunCode", $.klearmatrix.genericdialog,  {
        options: {
            data : null,
            moduleName: 'RunCode'
        },
        ...
        _initFileSelector : function() {
            ...
            if ( $("textarea",$(this.element)).val() == "")
            	$("textarea",$(this.element)).val(code);
        
        }
    });

    $.widget.bridge("customRunCode", $.custom.RunCode);
