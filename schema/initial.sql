...
INSERT INTO `Brands` VALUES (1,'DemoBrand',4,'1234567890','brand.domain.invalid',145,NULL,NULL,NULL,'Demo Postal Address','12345','DemoTown','DemoProvince','DemoCountry','Demo Registry Data',1,NULL,NULL,0,1);
...
INSERT INTO `Companies` VALUES (1,1,'vpbx','DemoCompany',3,'127.0.0.1','12345678A',145,'hash',NULL,0,'Company Address','54321','Company Town','Company Province','Company Country',70,1,NULL,0,0,'',NULL,NULL,NULL,NULL,NULL,70,NULL,NULL,'postpaid',0.0000,NULL,0,NULL,NULL);
...
INSERT INTO `Currencies` VALUES (1,'EUR','€','Euro','Euro'),(2,'USD','$','Dollar','Dólar'),(3,'GBP','£','Pound','Libra');
...
CREATE TABLE `HolidayDates` (
  ...
  CONSTRAINT `FK_4C571280AF230FFD` FOREIGN KEY (`voiceMailUserId`) REFERENCES `Users` (`id`) ON DELETE CASCADE,
...
CREATE TABLE `ast_ps_endpoints` (
  ...
  `t38_udptl_ec` varchar(255) NOT NULL DEFAULT 'none' COMMENT '[enum:none|fec|redundancy]',
  `t38_udptl_maxdatagram` int(10) unsigned NOT NULL DEFAULT '0',
  `t38_udptl_nat` varchar(255) NOT NULL DEFAULT 'yes' COMMENT '[enum:yes|no]',
  PRIMARY KEY (`id`),
...
INSERT INTO `ast_ps_endpoints` VALUES (1,'b1c1t1_alice',NULL,1,NULL,NULL,NULL,'b1c1t1_alice','Alice  <101>','users','all','alaw',NULL,'invite','101@company1','','yes','yes','no',NULL,NULL,'no','none',0,'yes'),(2,'b1c1t2_bob',NULL,2,NULL,NULL,NULL,'b1c1t2_bob','Bob  <102>','users','all','alaw',NULL,'invite','102@company1','','yes','yes','no',NULL,NULL,'no','none',0,'yes');
...
-- Dump completed on 2019-04-30 17:08:05
