...
final class Version20241009094523 extends LoggableMigration
{
    ...
    // this up() migration is auto-generated, please modify it to your needs
        $this->addSql('CREATE TABLE ApplicationServerSetsRelBrands (
            ...
            INDEX IDX_3D009C63C9049B0E (applicationServerSetId), 
            INDEX IDX_3D009C639CBEC244 (brandId), 
            UNIQUE INDEX applicationServerSet_brand (applicationServerSetId, brandId), 
            PRIMARY KEY(id)) 
            DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB'
        );

        $this->addSql('ALTER TABLE ApplicationServerSetsRelBrands ADD CONSTRAINT FK_3D009C63C9049B0E FOREIGN KEY (applicationServerSetId) REFERENCES ApplicationServerSets (id) ON DELETE RESTRICT');
        $this->addSql('ALTER TABLE ApplicationServerSetsRelBrands ADD CONSTRAINT FK_3D009C639CBEC244 FOREIGN KEY (brandId) REFERENCES Brands (id) ON DELETE CASCADE');

        $this->addSql('CREATE TABLE MediaRelaySetsRelBrands (
            id INT UNSIGNED AUTO_INCREMENT NOT NULL,
            brandId INT UNSIGNED NOT NULL, 
            mediaRelaySetId INT UNSIGNED NOT NULL,             
            INDEX IDX_DFCD36A4ED1C657C (mediaRelaySetId), 
