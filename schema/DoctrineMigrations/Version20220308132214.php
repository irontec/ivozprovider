 ...
 */
final class Version20220308132214 extends LoggableMigration
{
...
id, companyId, voicemailLocutionId FROM Users');
        ...
        $this->addSql('ALTER TABLE ExternalCallFilters CHANGE holidayVoiceMailUserId holidayVoicemailId INT UNSIGNED DEFAULT NULL');
        $this->addSql('ALTER TABLE ExternalCallFilters CHANGE outOfScheduleVoiceMailUserId outOfScheduleVoicemailId INT UNSIGNED DEFAULT NULL');
