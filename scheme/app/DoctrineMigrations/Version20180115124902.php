...
class Version20180115124902 extends AbstractMigration
{
    ...
    public function up(Schema $schema)
    {
        ...
        $this->addSql('CREATE TABLE RatingPlans (id INT UNSIGNED AUTO_INCREMENT NOT NULL, tag VARCHAR(64) DEFAULT NULL, name_en VARCHAR(55) NOT NULL, name_es VARCHAR(55) NOT NULL, description_en VARCHAR(255) NOT NULL, description_es VARCHAR(255) NOT NULL, destinationRateId INT UNSIGNED NOT NULL, brandId INT UNSIGNED NOT NULL, INDEX IDX_EB67DB9C4EB67480 (destinationRateId), INDEX brandId (brandId), UNIQUE INDEX brandTag (tag, brandId), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE RatingPlans ADD CONSTRAINT FK_EB67DB9C4EB67480 FOREIGN KEY (destinationRateId) REFERENCES DestinationRates (id) ON DELETE CASCADE');
