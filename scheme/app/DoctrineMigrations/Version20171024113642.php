...
class Version20171024113642 extends AbstractMigration
{
    ...
    public function up(Schema $schema)
    {
        ...
        $this->addSql('CREATE TABLE TransformationRules (id INT UNSIGNED AUTO_INCREMENT NOT NULL, type VARCHAR(10) NOT NULL COMMENT \'[enum:callerin|calleein|callerout|calleeout]\', description VARCHAR(64) DEFAULT \'\' NOT NULL, priority SMALLINT UNSIGNED DEFAULT NULL, matchExpr VARCHAR(128) DEFAULT NULL, replaceExpr VARCHAR(128) DEFAULT NULL, transformationRuleSetId INT UNSIGNED DEFAULT NULL, INDEX transformationRuleSet (transformationRuleSetId), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 ENGINE = InnoDB');
