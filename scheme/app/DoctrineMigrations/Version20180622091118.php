...
class Version20180622091118 extends AbstractMigration
{
    ...
    public function up(Schema $schema)
    {
        ...
        $this->addSql('CREATE TABLE InvoiceSchedulers (id INT UNSIGNED AUTO_INCREMENT NOT NULL, iden VARCHAR(40) NOT NULL, unit VARCHAR(30) DEFAULT \'month\' NOT NULL COMMENT \'[enum:week|month|year]\', frequency SMALLINT UNSIGNED NOT NULL, email VARCHAR(140) NOT NULL, inProgress TINYINT(1) DEFAULT \'0\' NOT NULL, lastExecution DATETIME DEFAULT NULL COMMENT \'(DC2Type:datetime)\', brandId INT UNSIGNED NOT NULL, invoiceNumberSequenceId INT UNSIGNED DEFAULT NULL, INDEX IDX_41E90A1A9CBEC244 (brandId), INDEX IDX_41E90A1A4539C703 (invoiceNumberSequenceId), UNIQUE INDEX invoiceNumberSequence_iden_brand (iden, brandId), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE InvoiceNumberSequences (id INT UNSIGNED AUTO_INCREMENT NOT NULL, iden VARCHAR(40) NOT NULL, prefix VARCHAR(20) DEFAULT \'\' NOT NULL, sequenceLength SMALLINT UNSIGNED NOT NULL, increment SMALLINT UNSIGNED NOT NULL, latestValue VARCHAR(255) DEFAULT \'\', iteration SMALLINT UNSIGNED DEFAULT 0 NOT NULL, version INT DEFAULT 1 NOT NULL, brandId INT UNSIGNED NOT NULL, INDEX IDX_A7624D1E9CBEC244 (brandId), UNIQUE INDEX invoiceNumberSequence_iden_brand (iden, brandId), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
