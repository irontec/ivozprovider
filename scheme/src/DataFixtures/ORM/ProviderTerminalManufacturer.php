...
class ProviderTerminalManufacturer extends Fixture
{
    ...
    public function load(ObjectManager $manager)
    {
        ...
        $this->addReference('_reference_IvozProviderDomainModelTerminalManufacturerTerminalManufacturer1', $item1);
        ...
        $this->addReference('_reference_IvozProviderDomainModelTerminalManufacturerTerminalManufacturer2', $item2);
        $manager->persist($item2);

        $item3 = $this->createEntityInstanceWithPublicMethods(TerminalManufacturer::class);
        $item3->setIden("Cisco");
        $item3->setName("Cisco");
        $this->addReference('_reference_IvozProviderDomainModelTerminalManufacturerTerminalManufacturer3', $item3);
        ...
        $this->addReference('_reference_IvozProviderDomainModelTerminalManufacturerTerminalManufacturer4', $item4);
