...
class ProviderAdministrator extends Fixture implements DependentFixtureInterface
{
    ...
    public function load(ObjectManager $manager)
    {
        ...
        $item1->setPass("\$2a\$08\$ToDhikHKFDznPJVrbPGpeONfmbr3Y9dIrvnyNgN8S7QZ918SeCF0W");
        ...
        $item2->setPass("\$2a\$08\$.FgQ155lxPIP.zBoouYvbOvedWVfNpChbmVKQMUfDKPPBWM4w7esG");
        ...
        $item3->setPass("\$2a\$08\$Kkb6jOA/6u9mf2Q2GvCV4.UB3MNpRYvoDQ11vpWSaWmLNnekaJ40S");
        ...
        $item4->setPass("\$2a\$08\$dSaGJTiDDmqrW2OUQ4M4EOMz7XyWEXNKg4.cIHjd4VXLWlNZcx/cC");
