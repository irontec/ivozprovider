...
INSERT INTO changelog
                                (change_number, delta_set, start_dt, applied_by, description) VALUES (1, 'Main', NOW(), 'dbdeploy', '001-oasis.sql');
...
INSERT INTO `Extensions` VALUES (1,1,'101','user',NULL,NULL,NULL,NULL,1),(2,1,'102','user',NULL,NULL,NULL,NULL,2);
...
-- Fragment begins: 2 --
INSERT INTO changelog
                                (change_number, delta_set, start_dt, applied_by, description) VALUES (2, 'Main', NOW(), 'dbdeploy', '002-lcr-rules-key.sql');
...
-- Fragment begins: 3 --
INSERT INTO changelog
                                (change_number, delta_set, start_dt, applied_by, description) VALUES (3, 'Main', NOW(), 'dbdeploy', '003-e164-detection.sql');
--
...
-- Fragment begins: 4 --
INSERT INTO changelog
                                (change_number, delta_set, start_dt, applied_by, description) VALUES (4, 'Main', NOW(), 'dbdeploy', '004-extension-route-number.sql');
--
...
-- Fragment begins: 5 --
INSERT INTO changelog
                                (change_number, delta_set, start_dt, applied_by, description) VALUES (5, 'Main', NOW(), 'dbdeploy', '005-chile-calling-format.sql');
...
-- Fragment begins: 6 --
INSERT INTO changelog
                                (change_number, delta_set, start_dt, applied_by, description) VALUES (6, 'Main', NOW(), 'dbdeploy', '006-users-defaults.sql');
ALTER TABLE Users MODIFY `username` varchar(50) DEFAULT NULL;
...
-- Fragment begins: 7 --
INSERT INTO changelog
                                (change_number, delta_set, start_dt, applied_by, description) VALUES (7, 'Main', NOW(), 'dbdeploy', '007-hints-user-extensions.sql');
DROP VIEW ast_hints;
...
-- Fragment begins: 8 --
INSERT INTO changelog
                                (change_number, delta_set, start_dt, applied_by, description) VALUES (8, 'Main', NOW(), 'dbdeploy', '008-huntgroup-noanswer-handler.sql');
--
...
-- Fragment begins: 9 --
INSERT INTO changelog
                                (change_number, delta_set, start_dt, applied_by, description) VALUES (9, 'Main', NOW(), 'dbdeploy', '009-sane-defaults.sql');
...
-- Fragment begins: 10 --
INSERT INTO changelog
                                (change_number, delta_set, start_dt, applied_by, description) VALUES (10, 'Main', NOW(), 'dbdeploy', '010-call-fw-unique.sql');
...
-- Fragment begins: 11 --
INSERT INTO changelog
                                (change_number, delta_set, start_dt, applied_by, description) VALUES (11, 'Main', NOW(), 'dbdeploy', '011-kam_users_location-models.sql');
...
-- Fragment begins: 12 --
INSERT INTO changelog
                                (change_number, delta_set, start_dt, applied_by, description) VALUES (12, 'Main', NOW(), 'dbdeploy', '012-friends-table.sql');
--
-- Main Friends table
...
-- Fragment begins: 13 --
INSERT INTO changelog
                                (change_number, delta_set, start_dt, applied_by, description) VALUES (13, 'Main', NOW(), 'dbdeploy', '013-endpoints-default-context.sql');
ALTER TABLE `ast_ps_endpoints` MODIFY `context` varchar(40) NOT NULL DEFAULT 'users';
...
-- Fragment begins: 14 --
INSERT INTO changelog
                                (change_number, delta_set, start_dt, applied_by, description) VALUES (14, 'Main', NOW(), 'dbdeploy', '014-username-is-email.sql');
...
-- Fragment begins: 15 --
INSERT INTO changelog
                                (change_number, delta_set, start_dt, applied_by, description) VALUES (15, 'Main', NOW(), 'dbdeploy', '015-multiddi-support.sql');
ALTER TABLE `kam_trunks_uacreg` ADD `multiDDI` tinyint(1) unsigned NOT NULL DEFAULT '0';
...
-- Fragment begins: 16 --
INSERT INTO changelog
                                (change_number, delta_set, start_dt, applied_by, description) VALUES (16, 'Main', NOW(), 'dbdeploy', '016-merge-terminals-n-friends.sql');
...
-- Fragment begins: 17 --
INSERT INTO changelog
                                (change_number, delta_set, start_dt, applied_by, description) VALUES (17, 'Main', NOW(), 'dbdeploy', '017-company-admin-unique.sql');
ALTER TABLE `CompanyAdmins` DROP KEY `usernameCompany`;
...
-- Fragment begins: 18 --
INSERT INTO changelog
                                (change_number, delta_set, start_dt, applied_by, description) VALUES (18, 'Main', NOW(), 'dbdeploy', '018-user-email-unique.sql');
...
-- Fragment begins: 19 --
INSERT INTO changelog
                                (change_number, delta_set, start_dt, applied_by, description) VALUES (19, 'Main', NOW(), 'dbdeploy', '019-optimize-index.sql');
...
-- Fragment begins: 20 --
INSERT INTO changelog
                                (change_number, delta_set, start_dt, applied_by, description) VALUES (20, 'Main', NOW(), 'dbdeploy', '020-parsed-cdrs.sql');
...
-- Fragment begins: 21 --
INSERT INTO changelog
                                (change_number, delta_set, start_dt, applied_by, description) VALUES (21, 'Main', NOW(), 'dbdeploy', '021-external-rater-extra-opts.sql');
...
-- Fragment begins: 22 --
INSERT INTO changelog
                                (change_number, delta_set, start_dt, applied_by, description) VALUES (22, 'Main', NOW(), 'dbdeploy', '022-from_domain-astpsendpoints.sql');
ALTER TABLE `ast_ps_endpoints` ADD `from_domain` varchar(255) DEFAULT NULL AFTER `sorcery_id`;
...
-- Fragment begins: 23 --
INSERT INTO changelog
                                (change_number, delta_set, start_dt, applied_by, description) VALUES (23, 'Main', NOW(), 'dbdeploy', '023-ddi-screen-name.sql');
/**
...
-- Fragment begins: 24 --
INSERT INTO changelog
                                (change_number, delta_set, start_dt, applied_by, description) VALUES (24, 'Main', NOW(), 'dbdeploy', '024-add-presence-modules.sql');
/**
 * Due to the way phing works, this delta was not applied when it should on
...
-- Fragment begins: 25 --
INSERT INTO changelog
                                (change_number, delta_set, start_dt, applied_by, description) VALUES (25, 'Main', NOW(), 'dbdeploy', '025-ivr-max-digits.sql');
...
-- Fragment begins: 26 --
INSERT INTO changelog
                                (change_number, delta_set, start_dt, applied_by, description) VALUES (26, 'Main', NOW(), 'dbdeploy', '026-ivr-entry-regexp.sql');
/**
...
-- Fragment begins: 27 --
INSERT INTO changelog
                                (change_number, delta_set, start_dt, applied_by, description) VALUES (27, 'Main', NOW(), 'dbdeploy', '027-mail-from-Brands.sql');
ALTER TABLE `Brands` ADD `FromName` varchar(255) DEFAULT NULL;
ALTER TABLE `Brands` ADD `FromAddress` varchar(255) DEFAULT NULL;
...
-- Fragment begins: 28 --
INSERT INTO changelog
                                (change_number, delta_set, start_dt, applied_by, description) VALUES (28, 'Main', NOW(), 'dbdeploy', '028-disable-voicemail-password.sql');
/**
...
-- Fragment begins: 29 --
INSERT INTO changelog
                                (change_number, delta_set, start_dt, applied_by, description) VALUES (29, 'Main', NOW(), 'dbdeploy', '029-services-same-code.sql');
...
-- Fragment begins: 30 --
INSERT INTO changelog
                                (change_number, delta_set, start_dt, applied_by, description) VALUES (30, 'Main', NOW(), 'dbdeploy', '030-add-language-ddi.sql');
...
-- Fragment begins: 31 --
INSERT INTO changelog
                                (change_number, delta_set, start_dt, applied_by, description) VALUES (31, 'Main', NOW(), 'dbdeploy', '031-add-language-friends.sql');
...
-- Fragment begins: 32 --
INSERT INTO changelog
                                (change_number, delta_set, start_dt, applied_by, description) VALUES (32, 'Main', NOW(), 'dbdeploy', '032-language-users-null.sql');
...
-- Fragment begins: 33 --
INSERT INTO changelog
                                (change_number, delta_set, start_dt, applied_by, description) VALUES (33, 'Main', NOW(), 'dbdeploy', '033-recordings-disk-limit.sql');
...
-- Fragment begins: 34 --
INSERT INTO changelog
                                (change_number, delta_set, start_dt, applied_by, description) VALUES (34, 'Main', NOW(), 'dbdeploy', '034-basic-queue-support.sql');
CREATE TABLE `Queues` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `companyId` int(10) unsigned NOT NULL,
...
-- Fragment begins: 35 --
INSERT INTO changelog
                                (change_number, delta_set, start_dt, applied_by, description) VALUES (35, 'Main', NOW(), 'dbdeploy', '035-features-by-brand.sql');
...
-- Fragment begins: 36 --
INSERT INTO changelog
                                (change_number, delta_set, start_dt, applied_by, description) VALUES (36, 'Main', NOW(), 'dbdeploy', '036-friend-use-reinvite.sql');
...
-- Fragment begins: 37 --
INSERT INTO changelog
                                (change_number, delta_set, start_dt, applied_by, description) VALUES (37, 'Main', NOW(), 'dbdeploy', '037-pricing-plan-rel-company-required-fields.sql');
...
-- Fragment begins: 38 --
INSERT INTO changelog
                                (change_number, delta_set, start_dt, applied_by, description) VALUES (38, 'Main', NOW(), 'dbdeploy', '038-voice-error-notifications.sql');
...
-- Fragment begins: 39 --
INSERT INTO changelog
                                (change_number, delta_set, start_dt, applied_by, description) VALUES (39, 'Main', NOW(), 'dbdeploy', '039-duid-not-used.sql');
...
-- Fragment begins: 40 --
INSERT INTO changelog
                                (change_number, delta_set, start_dt, applied_by, description) VALUES (40, 'Main', NOW(), 'dbdeploy', '040-kamailio-version.sql');
...
-- Fragment begins: 41 --
INSERT INTO changelog
                                (change_number, delta_set, start_dt, applied_by, description) VALUES (41, 'Main', NOW(), 'dbdeploy', '041-general-review.sql');
...
-- Fragment begins: 42 --
INSERT INTO changelog
                                (change_number, delta_set, start_dt, applied_by, description) VALUES (42, 'Main', NOW(), 'dbdeploy', '042-add-description-fixedCosts.sql');
...
-- Fragment begins: 43 --
INSERT INTO changelog
                                (change_number, delta_set, start_dt, applied_by, description) VALUES (43, 'Main', NOW(), 'dbdeploy', '043-company-outgoing-ddi.sql');
/**
...
-- Fragment begins: 44 --
INSERT INTO changelog
                                (change_number, delta_set, start_dt, applied_by, description) VALUES (44, 'Main', NOW(), 'dbdeploy', '044-disable-lcr-strip-n-prefix.sql');
...
-- Fragment begins: 45 --
INSERT INTO changelog
                                (change_number, delta_set, start_dt, applied_by, description) VALUES (45, 'Main', NOW(), 'dbdeploy', '045-callwaiting-to-maxcalls.sql');
...
-- Fragment begins: 46 --
INSERT INTO changelog
                                (change_number, delta_set, start_dt, applied_by, description) VALUES (46, 'Main', NOW(), 'dbdeploy', '046-operators-required-fields.sql');
ALTER TABLE `MainOperators` MODIFY `name` varchar(100) DEFAULT NULL;
ALTER TABLE `MainOperators` MODIFY `lastname` varchar(100) DEFAULT NULL;
ALTER TABLE `BrandOperators` MODIFY `name` varchar(100) DEFAULT NULL;
ALTER TABLE `BrandOperators` MODIFY `lastname` varchar(100) DEFAULT NULL;
ALTER TABLE `CompanyAdmins` MODIFY `name` varchar(100) DEFAULT NULL;
ALTER TABLE `CompanyAdmins` MODIFY `lastname` varchar(100) DEFAULT NULL;
...
-- Fragment begins: 47 --
INSERT INTO changelog
                                (change_number, delta_set, start_dt, applied_by, description) VALUES (47, 'Main', NOW(), 'dbdeploy', '047-users-drop-username.sql');
...
-- Fragment begins: 48 --
INSERT INTO changelog
                                (change_number, delta_set, start_dt, applied_by, description) VALUES (48, 'Main', NOW(), 'dbdeploy', '048-ip-lengths.sql');
...
-- Fragment begins: 49 --
INSERT INTO changelog
                                (change_number, delta_set, start_dt, applied_by, description) VALUES (49, 'Main', NOW(), 'dbdeploy', '049-peerserver-name.sql');
...
-- Fragment begins: 50 --
INSERT INTO changelog
                                (change_number, delta_set, start_dt, applied_by, description) VALUES (50, 'Main', NOW(), 'dbdeploy', '050-add-presence-modules.sql');
/**
...
-- Fragment begins: 51 --
INSERT INTO changelog
                                (change_number, delta_set, start_dt, applied_by, description) VALUES (51, 'Main', NOW(), 'dbdeploy', '051-fix-missing-delta-041.sql');
/**
...
-- Fragment begins: 52 --
INSERT INTO changelog
                                (change_number, delta_set, start_dt, applied_by, description) VALUES (52, 'Main', NOW(), 'dbdeploy', '052-terminals-video-support.sql');
...
-- Fragment begins: 53 --
INSERT INTO changelog
                                (change_number, delta_set, start_dt, applied_by, description) VALUES (53, 'Main', NOW(), 'dbdeploy', '053-active-operators.sql');
...
-- Fragment begins: 54 --
INSERT INTO changelog
                                (change_number, delta_set, start_dt, applied_by, description) VALUES (54, 'Main', NOW(), 'dbdeploy', '054-retail-customers.sql');
...
-- Fragment begins: 55 --
INSERT INTO changelog
                                (change_number, delta_set, start_dt, applied_by, description) VALUES (55, 'Main', NOW(), 'dbdeploy', '055-record-locution-service.sql');
...
-- Fragment begins: 56 --
INSERT INTO changelog
                                (change_number, delta_set, start_dt, applied_by, description) VALUES (56, 'Main', NOW(), 'dbdeploy', '056-delete-stats-on-delete.sql');
...
-- Fragment begins: 57 --
INSERT INTO changelog
                                (change_number, delta_set, start_dt, applied_by, description) VALUES (57, 'Main', NOW(), 'dbdeploy', '057-fix-notify-uri.sql');
DROP VIEW IF EXISTS `kam_users_dbaliases`;
...
-- Fragment begins: 58 --
INSERT INTO changelog
                                (change_number, delta_set, start_dt, applied_by, description) VALUES (58, 'Main', NOW(), 'dbdeploy', '058-Invoice-templates-footer-and-header.sql');
...
-- Fragment begins: 59 --
INSERT INTO changelog
                                (change_number, delta_set, start_dt, applied_by, description) VALUES (59, 'Main', NOW(), 'dbdeploy', '059-simplify-kam_users-view.sql');
...
-- Fragment begins: 60 --
INSERT INTO changelog
                                (change_number, delta_set, start_dt, applied_by, description) VALUES (60, 'Main', NOW(), 'dbdeploy', '060-skip-ip-check-roadwarriors.sql');
...
-- Fragment begins: 61 --
INSERT INTO changelog
                                (change_number, delta_set, start_dt, applied_by, description) VALUES (61, 'Main', NOW(), 'dbdeploy', '061-fix-recordings-storage-path.sql');
...
-- Fragment begins: 62 --
INSERT INTO changelog
                                (change_number, delta_set, start_dt, applied_by, description) VALUES (62, 'Main', NOW(), 'dbdeploy', '062-Increase-companies-externallyExtraOpts.sql');
...
-- Fragment begins: 63 --
INSERT INTO changelog
                                (change_number, delta_set, start_dt, applied_by, description) VALUES (63, 'Main', NOW(), 'dbdeploy', '063-Specific-provision-route-fix.sql');
...
-- Fragment begins: 64 --
INSERT INTO changelog
                                (change_number, delta_set, start_dt, applied_by, description) VALUES (64, 'Main', NOW(), 'dbdeploy', '064-external-whiteblack-lists.sql');
...
-- Fragment begins: 65 --
INSERT INTO changelog
                                (change_number, delta_set, start_dt, applied_by, description) VALUES (65, 'Main', NOW(), 'dbdeploy', '065-outgoing-ddi-rules.sql');
...
-- Fragment begins: 66 --
INSERT INTO changelog
                                (change_number, delta_set, start_dt, applied_by, description) VALUES (66, 'Main', NOW(), 'dbdeploy', '066-users-add-gsQRCode.sql');
...
-- Fragment begins: 67 --
INSERT INTO changelog
                                (change_number, delta_set, start_dt, applied_by, description) VALUES (67, 'Main', NOW(), 'dbdeploy', '067-voicemail-locution.sql');
...
-- Fragment begins: 68 --
INSERT INTO changelog
                                (change_number, delta_set, start_dt, applied_by, description) VALUES (68, 'Main', NOW(), 'dbdeploy', '068-asterisk-subscribecontext.sql');
...
-- Fragment begins: 69 --
INSERT INTO changelog
                                (change_number, delta_set, start_dt, applied_by, description) VALUES (69, 'Main', NOW(), 'dbdeploy', '069-conditional-routes.sql');
...
-- Fragment begins: 70 --
INSERT INTO changelog
                                (change_number, delta_set, start_dt, applied_by, description) VALUES (70, 'Main', NOW(), 'dbdeploy', '070-asterisk-named-pickup.sql');
ALTER TABLE `ast_ps_endpoints` CHANGE `pickup_group` `named_pickup_group` varchar(40) DEFAULT NULL;
